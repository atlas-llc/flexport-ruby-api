...
module Flexport
  class BundlesApi
    ...
    # @param api_bundle [ApiBundle] 
    # @param [Hash] opts the optional parameters
    # @return [ApiBundleResponse]
    def create_bundle(api_bundle, opts = {})
      data, _status_code, _headers = create_bundle_with_http_info(api_bundle, opts)
      data
    end
    ...
    # @param api_bundle [ApiBundle] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiBundleResponse, Integer, Hash)>] ApiBundleResponse data, response status code and response headers
    def create_bundle_with_http_info(api_bundle, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BundlesApi.create_bundle ...'
      end
      # verify the required parameter 'api_bundle' is set
      if @api_client.config.client_side_validation && api_bundle.nil?
        fail ArgumentError, "Missing the required parameter 'api_bundle' when calling BundlesApi.create_bundle"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/bundles'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(api_bundle)

      # return_type
      return_type = opts[:debug_return_type] || 'ApiBundleResponse'
    ...
    def get_bundle_with_http_info(bundle_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/bundles/{bundleId}'.sub('{' + 'bundleId' + '}', CGI.escape(bundle_id.to_s))
    ...
    # @param bundle_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [ApiBundleInventoryResponse]
    ...
    # @param bundle_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiBundleInventoryResponse, Integer, Hash)>] ApiBundleInventoryResponse data, response status code and response headers
    def get_bundle_inventory_with_http_info(bundle_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/bundles/{bundleId}/inventory'.sub('{' + 'bundleId' + '}', CGI.escape(bundle_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiBundleInventoryResponse'
