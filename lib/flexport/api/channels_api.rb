...
module Flexport
  class ChannelsApi
    ...
    # @param create_channel_input [CreateChannelInput] 
    # @param [Hash] opts the optional parameters
    # @return [CreateChannelOutput]
    def create_channel(create_channel_input, opts = {})
      data, _status_code, _headers = create_channel_with_http_info(create_channel_input, opts)
      data
    end
    ...
    # @param create_channel_input [CreateChannelInput] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateChannelOutput, Integer, Hash)>] CreateChannelOutput data, response status code and response headers
    def create_channel_with_http_info(create_channel_input, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelsApi.create_channel ...'
      end
      # verify the required parameter 'create_channel_input' is set
      if @api_client.config.client_side_validation && create_channel_input.nil?
        fail ArgumentError, "Missing the required parameter 'create_channel_input' when calling ChannelsApi.create_channel"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/channels'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_channel_input)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateChannelOutput'
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def create_product_sync(channel_type, store_name, opts = {})
      create_product_sync_with_http_info(channel_type, store_name, opts)
      nil
    end
    ...
    def create_product_sync_with_http_info(channel_type, store_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelsApi.create_product_sync ...'
      end
      # verify the required parameter 'channel_type' is set
      if @api_client.config.client_side_validation && channel_type.nil?
        fail ArgumentError, "Missing the required parameter 'channel_type' when calling ChannelsApi.create_product_sync"
      end
      # verify the required parameter 'store_name' is set
      if @api_client.config.client_side_validation && store_name.nil?
        fail ArgumentError, "Missing the required parameter 'store_name' when calling ChannelsApi.create_product_sync"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/channels/{channelType}/shop/{storeName}/sync'.sub('{' + 'channelType' + '}', CGI.escape(channel_type.to_s)).sub('{' + 'storeName' + '}', CGI.escape(store_name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ChannelsApi.create_product_sync",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelsApi#create_product_sync\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_product_sync_status(channel_type, store_name, opts = {})
      data, _status_code, _headers = get_product_sync_status_with_http_info(channel_type, store_name, opts)
      data
    end
    ...
    # @param store_name [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProductSyncStatus, Integer, Hash)>] ProductSyncStatus data, response status code and response headers
    def get_product_sync_status_with_http_info(channel_type, store_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelsApi.get_product_sync_status ...'
      end
      # verify the required parameter 'channel_type' is set
      if @api_client.config.client_side_validation && channel_type.nil?
        fail ArgumentError, "Missing the required parameter 'channel_type' when calling ChannelsApi.get_product_sync_status"
      end
      # verify the required parameter 'store_name' is set
      if @api_client.config.client_side_validation && store_name.nil?
        fail ArgumentError, "Missing the required parameter 'store_name' when calling ChannelsApi.get_product_sync_status"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/channels/{channelType}/shop/{storeName}/sync'.sub('{' + 'channelType' + '}', CGI.escape(channel_type.to_s)).sub('{' + 'storeName' + '}', CGI.escape(store_name.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ProductSyncStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BEARER']

      new_options = opts.merge(
        :operation => :"ChannelsApi.get_product_sync_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelsApi#get_product_sync_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
