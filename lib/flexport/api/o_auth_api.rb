...
module Flexport
  class OAuthApi
    ...
    # @param client_id [String] Must be set to &lt;i&gt;identity&lt;/i&gt; to create an API token tied to your Shopify Logistics Seller Portal user identity.
    # @param scope [String] The scope of the authorization request.  Multiple scopes may be provided, separated by &#39; &#39;. Possible scope values are: read_logistics_products write_logistics_products read_logistics_reports write_logistics_reports read_logistics_bundles write_logistics_bundles read_logistics_orders write_logistics_orders read_logistics_webhooks write_logistics_webhooks read_logistics_parcels write_logistics_parcels read_logistics_returns write_logistics_returns read_logistics_freight write_logistics_freight read_logistics_events read_logistics_inbounds write_logistics_inbounds
    # @param [Hash] opts the optional parameters
    # @option opts [String] :redirect_uri Optional. OAuth flow redirects to the redirect_uri after successful authentication with the one-time use \&quot;code\&quot; passed as query parameter. If &lt;i&gt;identity&lt;/i&gt; client_id is used, redirect is to the Shopify Logistics Seller Portal UI page.
    # @option opts [String] :state An opaque value used by the client to maintain state between the request and callback.  The authorization server includes this value when redirecting the user-agent back to the client.
    # @option opts [AuthFlow] :auth_flow Reserved for use by partners.
    # @return [nil]
    def authorization_redirect(response_type, client_id, scope, opts = {})
      authorization_redirect_with_http_info(response_type, client_id, scope, opts)
      nil
    end
    ...
    def authorization_redirect_with_http_info(response_type, client_id, scope, opts = {})
      ...
      if @api_client.config.client_side_validation && response_type.nil?
        fail ArgumentError, "Missing the required parameter 'response_type' when calling OAuthApi.authorization_redirect"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OAuthApi.authorization_redirect"
      end
      # verify the required parameter 'scope' is set
      if @api_client.config.client_side_validation && scope.nil?
        fail ArgumentError, "Missing the required parameter 'scope' when calling OAuthApi.authorization_redirect"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/oauth/authorize'
      ...
      query_params[:'authFlow'] = opts[:'auth_flow'] if !opts[:'auth_flow'].nil?
    ...
    # @param grant_type [GrantTypes] Value MUST be set to \\\&quot;authorization_code\\\&quot;.
    # @param code [String] The authorization code received from the authorization server.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :redirect_uri Required, if the \\\&quot;redirect_uri\\\&quot; parameter was included in the authorization request as described, and must be identical to the value included in the authorization request.
    # @return [TokenResponse]
    def token_exchange(grant_type, code, opts = {})
      data, _status_code, _headers = token_exchange_with_http_info(grant_type, code, opts)
      data
    end
    ...
    def token_exchange_with_http_info(grant_type, code, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuthApi.token_exchange ...'
      end
      # verify the required parameter 'grant_type' is set
      if @api_client.config.client_side_validation && grant_type.nil?
        fail ArgumentError, "Missing the required parameter 'grant_type' when calling OAuthApi.token_exchange"
      end
      # verify the required parameter 'code' is set
      if @api_client.config.client_side_validation && code.nil?
        fail ArgumentError, "Missing the required parameter 'code' when calling OAuthApi.token_exchange"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/oauth/token'
      ...
      new_options = opts.merge(
        :operation => :"OAuthApi.token_exchange",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuthApi#token_exchange\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
