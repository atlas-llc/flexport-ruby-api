...
module Flexport
  class OrdersApi
    ...
    # @param order_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(OrderModel, Integer, Hash)>] OrderModel data, response status code and response headers
    def cancel_order_with_http_info(order_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/orders/{orderId}/cancel'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OrderModel'
    ...
    # @param create_order_input202307 [CreateOrderInput202307] 
    # @param [Hash] opts the optional parameters
    # @return [OrderModel]
    def create_order202307(create_order_input202307, opts = {})
      data, _status_code, _headers = create_order202307_with_http_info(create_order_input202307, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(OrderModel, Integer, Hash)>] OrderModel data, response status code and response headers
    def create_order202307_with_http_info(create_order_input202307, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrdersApi.create_order202307 ...'
      end
      # verify the required parameter 'create_order_input202307' is set
      if @api_client.config.client_side_validation && create_order_input202307.nil?
        fail ArgumentError, "Missing the required parameter 'create_order_input202307' when calling OrdersApi.create_order202307"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/orders'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_order_input202307)
      ...
      new_options = opts.merge(
        :operation => :"OrdersApi.create_order202307",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrdersApi#create_order202307\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_order_with_http_info(order_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/orders/{orderId}'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
    ...
    def get_order_by_external_id_with_http_info(external_order_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/orders/external_id/{externalOrderId}'.sub('{' + 'externalOrderId' + '}', CGI.escape(external_order_id.to_s))
    ...
    def retry_order_with_http_info(order_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/orders/{orderId}/retry'.sub('{' + 'orderId' + '}', CGI.escape(order_id.to_s))
