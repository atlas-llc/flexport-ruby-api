...
module Flexport
  class ParcelsApi
    ...
    # @param cancel_parcel_request [CancelParcelRequest] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def cancel_parcel(cancel_parcel_request, opts = {})
      cancel_parcel_with_http_info(cancel_parcel_request, opts)
      nil
    end
    ...
    def cancel_parcel_with_http_info(cancel_parcel_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ParcelsApi.cancel_parcel ...'
      end
      # verify the required parameter 'cancel_parcel_request' is set
      if @api_client.config.client_side_validation && cancel_parcel_request.nil?
        fail ArgumentError, "Missing the required parameter 'cancel_parcel_request' when calling ParcelsApi.cancel_parcel"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/cancel'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(cancel_parcel_request)
      ...
      new_options = opts.merge(
        :operation => :"ParcelsApi.cancel_parcel",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ParcelsApi#cancel_parcel\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # Create a Bulk Parcel Job.
    # @param body [BulkParcelJobRequest] The bulk parcel job request
    # @param [Hash] opts the optional parameters
    # @return [BulkParcelJobResponse]
    def create_bulk_parcel_job(body, opts = {})
      data, _status_code, _headers = create_bulk_parcel_job_with_http_info(body, opts)
      data
    end
    ...
    # @param body [BulkParcelJobRequest] The bulk parcel job request
    # @param [Hash] opts the optional parameters
    # @return [Array<(BulkParcelJobResponse, Integer, Hash)>] BulkParcelJobResponse data, response status code and response headers
    def create_bulk_parcel_job_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ParcelsApi.create_bulk_parcel_job ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ParcelsApi.create_bulk_parcel_job"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/jobs'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BulkParcelJobResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BEARER']

      new_options = opts.merge(
        :operation => :"ParcelsApi.create_bulk_parcel_job",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ParcelsApi#create_bulk_parcel_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param body [CreateParcelRequestUnstable] 
    # @param [Hash] opts the optional parameters
    # @return [Parcel]
    def create_parcel_v3(body, opts = {})
      data, _status_code, _headers = create_parcel_v3_with_http_info(body, opts)
      data
    end
    ...
    # @param body [CreateParcelRequestUnstable] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Parcel, Integer, Hash)>] Parcel data, response status code and response headers
    def create_parcel_v3_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ParcelsApi.create_parcel_v3 ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ParcelsApi.create_parcel_v3"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/parcels'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Parcel'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BEARER']

      new_options = opts.merge(
        :operation => :"ParcelsApi.create_parcel_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ParcelsApi#create_parcel_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [Float] The Bulk Parcel Job ID
    # @param [Hash] opts the optional parameters
    # @return [BulkParcelJobResponse]
    def get_bulk_parcel_job(id, opts = {})
      data, _status_code, _headers = get_bulk_parcel_job_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(BulkParcelJobResponse, Integer, Hash)>] BulkParcelJobResponse data, response status code and response headers
    def get_bulk_parcel_job_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ParcelsApi.get_bulk_parcel_job ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ParcelsApi.get_bulk_parcel_job"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/jobs/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ParcelsApi.get_bulk_parcel_job",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ParcelsApi#get_bulk_parcel_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_parcel_with_http_info(parcel_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/{parcelId}'.sub('{' + 'parcelId' + '}', CGI.escape(parcel_id.to_s))
    ...
    # @param body [CreateQuoteRequest] 
    # @param [Hash] opts the optional parameters
    # @return [ParcelQuoteResponse]
    def get_parcel_quote_v2(body, opts = {})
      data, _status_code, _headers = get_parcel_quote_v2_with_http_info(body, opts)
      data
    end
    ...
    # @param body [CreateQuoteRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ParcelQuoteResponse, Integer, Hash)>] ParcelQuoteResponse data, response status code and response headers
    def get_parcel_quote_v2_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ParcelsApi.get_parcel_quote_v2 ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ParcelsApi.get_parcel_quote_v2"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/quote'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ParcelQuoteResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BEARER']

      new_options = opts.merge(
        :operation => :"ParcelsApi.get_parcel_quote_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ParcelsApi#get_parcel_quote_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param parcel_id [String] Unique ID used to track the parcel, returned after acquiring a purchase label.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ParcelTracking, Integer, Hash)>] ParcelTracking data, response status code and response headers
    def get_parcel_tracking_with_http_info(parcel_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/{parcelId}/tracking'.sub('{' + 'parcelId' + '}', CGI.escape(parcel_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ParcelTracking'
    ...
    # @param tracking_code [String] tracking code used to track the parcel
    # @param [Hash] opts the optional parameters
    # @return [ParcelTracking]
    def get_parcel_tracking_by_tracking_code(tracking_code, opts = {})
      data, _status_code, _headers = get_parcel_tracking_by_tracking_code_with_http_info(tracking_code, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ParcelTracking, Integer, Hash)>] ParcelTracking data, response status code and response headers
    def get_parcel_tracking_by_tracking_code_with_http_info(tracking_code, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ParcelsApi.get_parcel_tracking_by_tracking_code ...'
      end
      # verify the required parameter 'tracking_code' is set
      if @api_client.config.client_side_validation && tracking_code.nil?
        fail ArgumentError, "Missing the required parameter 'tracking_code' when calling ParcelsApi.get_parcel_tracking_by_tracking_code"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/tracking/{trackingCode}'.sub('{' + 'trackingCode' + '}', CGI.escape(tracking_code.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ParcelsApi.get_parcel_tracking_by_tracking_code",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ParcelsApi#get_parcel_tracking_by_tracking_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_tracking_url_with_http_info(parcel_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/parcels/{parcelId}/tracking_url'.sub('{' + 'parcelId' + '}', CGI.escape(parcel_id.to_s))
