...
module Flexport
  class ProductsApi
    ...
    # Create a product
    # @param create_product_model [CreateProductModel] 
    # @param [Hash] opts the optional parameters
    # @return [ApiProductResponse]
    def create_product(create_product_model, opts = {})
      data, _status_code, _headers = create_product_with_http_info(create_product_model, opts)
      data
    end
    ...
    # @param create_product_model [CreateProductModel] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiProductResponse, Integer, Hash)>] ApiProductResponse data, response status code and response headers
    def create_product_with_http_info(create_product_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductsApi.create_product ...'
      end
      # verify the required parameter 'create_product_model' is set
      if @api_client.config.client_side_validation && create_product_model.nil?
        fail ArgumentError, "Missing the required parameter 'create_product_model' when calling ProductsApi.create_product"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/products'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_product_model)

      # return_type
      return_type = opts[:debug_return_type] || 'ApiProductResponse'
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Float] :limit number of records to return, defaults to 20, capped at 100 (default to 20)
    # @option opts [Float] :offset number of records to skip before returning, defaults to 0 (default to 0)
    # @option opts [InventoryPool] :pool_name 
    # @return [Array<ApiInventoryResponse>]
    ...
    # @option opts [Float] :offset number of records to skip before returning, defaults to 0 (default to 0)
    # @option opts [InventoryPool] :pool_name 
    # @return [Array<(Array<ApiInventoryResponse>, Integer, Hash)>] Array<ApiInventoryResponse> data, response status code and response headers
    def get_all_inventory_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductsApi.get_all_inventory ...'
      end
      # resource path
      local_var_path = '/logistics/api/unstable/products/inventory/all'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ApiInventoryResponse>'
    ...
    # @param logistics_sku [String] The globally unique product identifier created by Deliverr and assigned on product creation.
    # @param [Hash] opts the optional parameters
    # @option opts [InventoryPool] :pool_name 
    # @option opts [Boolean] :aggregate_packs 
    # @return [ApiInventoryResponse]
    def get_inventory(logistics_sku, opts = {})
      data, _status_code, _headers = get_inventory_with_http_info(logistics_sku, opts)
      data
    end
    ...
    # @option opts [InventoryPool] :pool_name 
    # @option opts [Boolean] :aggregate_packs 
    # @return [Array<(ApiInventoryResponse, Integer, Hash)>] ApiInventoryResponse data, response status code and response headers
    def get_inventory_with_http_info(logistics_sku, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductsApi.get_inventory ...'
      end
      # verify the required parameter 'logistics_sku' is set
      if @api_client.config.client_side_validation && logistics_sku.nil?
        fail ArgumentError, "Missing the required parameter 'logistics_sku' when calling ProductsApi.get_inventory"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/products/{logisticsSku}/inventory'.sub('{' + 'logisticsSku' + '}', CGI.escape(logistics_sku.to_s))

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'poolName'] = opts[:'pool_name'] if !opts[:'pool_name'].nil?
      query_params[:'aggregatePacks'] = opts[:'aggregate_packs'] if !opts[:'aggregate_packs'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiInventoryResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BEARER']

      new_options = opts.merge(
        :operation => :"ProductsApi.get_inventory",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductsApi#get_inventory\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ApiProductResponse]
    def get_product(logistics_sku, opts = {})
      data, _status_code, _headers = get_product_with_http_info(logistics_sku, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiProductResponse, Integer, Hash)>] ApiProductResponse data, response status code and response headers
    def get_product_with_http_info(logistics_sku, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductsApi.get_product ...'
      end
      # verify the required parameter 'logistics_sku' is set
      if @api_client.config.client_side_validation && logistics_sku.nil?
        fail ArgumentError, "Missing the required parameter 'logistics_sku' when calling ProductsApi.get_product"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/products/{logisticsSku}'.sub('{' + 'logisticsSku' + '}', CGI.escape(logistics_sku.to_s))
    ...
    # @option opts [Float] :limit number of records to return, defaults to 20, capped at 100 (default to 20)
    # @option opts [Float] :offset number of records to skip before returning, defaults to 0 (default to 0)
    # @return [Array<ApiProductResponse>]
    ...
    # @option opts [Float] :limit number of records to return, defaults to 20, capped at 100 (default to 20)
    # @option opts [Float] :offset number of records to skip before returning, defaults to 0 (default to 0)
    # @return [Array<(Array<ApiProductResponse>, Integer, Hash)>] Array<ApiProductResponse> data, response status code and response headers
    def get_products_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ApiProductResponse>'
    ...
    # @param logistics_skus [LogisticsSkus] 
    # @param [Hash] opts the optional parameters
    # @option opts [InventoryPool] :pool_name 
    # @return [Array<WarehouseDetailsResponse>]
    def get_warehouse_details(logistics_skus, opts = {})
      data, _status_code, _headers = get_warehouse_details_with_http_info(logistics_skus, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [InventoryPool] :pool_name 
    # @return [Array<(Array<WarehouseDetailsResponse>, Integer, Hash)>] Array<WarehouseDetailsResponse> data, response status code and response headers
    def get_warehouse_details_with_http_info(logistics_skus, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductsApi.get_warehouse_details ...'
      end
      # verify the required parameter 'logistics_skus' is set
      if @api_client.config.client_side_validation && logistics_skus.nil?
        fail ArgumentError, "Missing the required parameter 'logistics_skus' when calling ProductsApi.get_warehouse_details"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/products/warehouse'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(logistics_skus)

      # return_type
      return_type = opts[:debug_return_type] || 'Array<WarehouseDetailsResponse>'
