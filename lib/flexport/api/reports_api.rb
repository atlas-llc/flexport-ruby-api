...
module Flexport
  class ReportsApi
    ...
    def generate_report_with_http_info(report_generation_request, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/reports'
    ...
    def get_report_status_with_http_info(report_reference, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/reports/{reportReference}'.sub('{' + 'reportReference' + '}', CGI.escape(report_reference.to_s))
