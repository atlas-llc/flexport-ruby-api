...
module Flexport
  class ReturnsApi
    ...
    # @option opts [String] :external_return_id 
    # @option opts [String] :rma 
    # @option opts [String] :tracking_code 
    # @option opts [Array<ReturnOrderStatus>] :status 
    # @option opts [Integer] :limit 
    # @option opts [String] :page_info 
    # @return [Array<ReturnsApiOrder>]
    def get_returns(opts = {})
      data, _status_code, _headers = get_returns_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :page_info 
    # @return [Array<(Array<ReturnsApiOrder>, Integer, Hash)>] Array<ReturnsApiOrder> data, response status code and response headers
    def get_returns_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReturnsApi.get_returns ...'
      end
      # resource path
      local_var_path = '/logistics/api/unstable/returns'

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'externalReturnId'] = opts[:'external_return_id'] if !opts[:'external_return_id'].nil?
      query_params[:'rma'] = opts[:'rma'] if !opts[:'rma'].nil?
      query_params[:'trackingCode'] = opts[:'tracking_code'] if !opts[:'tracking_code'].nil?
      query_params[:'status'] = @api_client.build_collection_param(opts[:'status'], :multi) if !opts[:'status'].nil?
      query_params[:'limit'] = opts[:'limit'] if !opts[:'limit'].nil?
      query_params[:'page_info'] = opts[:'page_info'] if !opts[:'page_info'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ReturnsApiOrder>'
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def returns_cancel_order(return_id, opts = {})
      returns_cancel_order_with_http_info(return_id, opts)
      nil
    end
    ...
    def returns_cancel_order_with_http_info(return_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReturnsApi.returns_cancel_order ...'
      end
      # verify the required parameter 'return_id' is set
      if @api_client.config.client_side_validation && return_id.nil?
        fail ArgumentError, "Missing the required parameter 'return_id' when calling ReturnsApi.returns_cancel_order"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/returns/{returnId}/cancel'.sub('{' + 'returnId' + '}', CGI.escape(return_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ReturnsApi.returns_cancel_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReturnsApi#returns_cancel_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # Creates return order for inspection.
    # @param create_return_request [CreateReturnRequest] 
    # @param [Hash] opts the optional parameters
    # @return [ReturnsApiOrder]
    def returns_create_order(create_return_request, opts = {})
      data, _status_code, _headers = returns_create_order_with_http_info(create_return_request, opts)
      data
    end
    ...
    def returns_create_order_with_http_info(create_return_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReturnsApi.returns_create_order ...'
      end
      # verify the required parameter 'create_return_request' is set
      if @api_client.config.client_side_validation && create_return_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_return_request' when calling ReturnsApi.returns_create_order"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/returns'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_return_request)
      ...
      new_options = opts.merge(
        :operation => :"ReturnsApi.returns_create_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReturnsApi#returns_create_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # Get return by returnId. This will include ReturnOrder, ReturnItems with inspection status and ShippingLabel.
    # @param return_id [Float] Unique ID used to track the return.
    # @param [Hash] opts the optional parameters
    # @return [ReturnsApiOrder]
    def returns_get_order(return_id, opts = {})
      data, _status_code, _headers = returns_get_order_with_http_info(return_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReturnsApiOrder, Integer, Hash)>] ReturnsApiOrder data, response status code and response headers
    def returns_get_order_with_http_info(return_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReturnsApi.returns_get_order ...'
      end
      # verify the required parameter 'return_id' is set
      if @api_client.config.client_side_validation && return_id.nil?
        fail ArgumentError, "Missing the required parameter 'return_id' when calling ReturnsApi.returns_get_order"
      end
      # resource path
      local_var_path = '/logistics/api/unstable/returns/{returnId}'.sub('{' + 'returnId' + '}', CGI.escape(return_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ReturnsApi.returns_get_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReturnsApi#returns_get_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
