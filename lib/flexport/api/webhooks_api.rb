...
module Flexport
  class WebhooksApi
    ...
    def create_webhook_with_http_info(webhook_create_model, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/webhooks'
    ...
    def delete_webhook_with_http_info(webhook_id, opts = {})
      ...
      # resource path
      local_var_path = '/logistics/api/unstable/webhooks/{webhookId}'.sub('{' + 'webhookId' + '}', CGI.escape(webhook_id.to_s))
