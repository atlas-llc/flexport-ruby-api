...
module Flexport
  # Response getting a logistic account's standing status
  class AccountStandingStatusOutput
    # Logistics account ID
    attr_accessor :logistics_account_id

    # Whether account can accept fulfillment orders
    attr_accessor :is_fully_setup

    # Whether product catalog has been imported
    attr_accessor :imported_product_catalog

    # Whether the first inbound shipment has been completed
    attr_accessor :completed_first_inbound_shipment
    ...
    def self.attribute_map
      {
        ...
        :'imported_product_catalog' => :'importedProductCatalog',
        :'completed_first_inbound_shipment' => :'completedFirstInboundShipment'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'imported_product_catalog' => :'Boolean',
        :'completed_first_inbound_shipment' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::AccountStandingStatusOutput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::AccountStandingStatusOutput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'logistics_account_id')
        self.logistics_account_id = attributes[:'logistics_account_id']
      else
        self.logistics_account_id = nil
      end

      if attributes.key?(:'is_fully_setup')
        self.is_fully_setup = attributes[:'is_fully_setup']
      else
        self.is_fully_setup = nil
      end

      if attributes.key?(:'imported_product_catalog')
        self.imported_product_catalog = attributes[:'imported_product_catalog']
      else
        self.imported_product_catalog = nil
      end

      if attributes.key?(:'completed_first_inbound_shipment')
        self.completed_first_inbound_shipment = attributes[:'completed_first_inbound_shipment']
      else
        self.completed_first_inbound_shipment = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @logistics_account_id.nil?
        invalid_properties.push('invalid value for "logistics_account_id", logistics_account_id cannot be nil.')
      end

      if @is_fully_setup.nil?
        invalid_properties.push('invalid value for "is_fully_setup", is_fully_setup cannot be nil.')
      end

      if @imported_product_catalog.nil?
        invalid_properties.push('invalid value for "imported_product_catalog", imported_product_catalog cannot be nil.')
      end

      if @completed_first_inbound_shipment.nil?
        invalid_properties.push('invalid value for "completed_first_inbound_shipment", completed_first_inbound_shipment cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @logistics_account_id.nil?
      return false if @is_fully_setup.nil?
      return false if @imported_product_catalog.nil?
      return false if @completed_first_inbound_shipment.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          logistics_account_id == o.logistics_account_id &&
          is_fully_setup == o.is_fully_setup &&
          imported_product_catalog == o.imported_product_catalog &&
          completed_first_inbound_shipment == o.completed_first_inbound_shipment
    end
    ...
    def hash
      [logistics_account_id, is_fully_setup, imported_product_catalog, completed_first_inbound_shipment].hash
    end
