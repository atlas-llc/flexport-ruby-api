...
module Flexport
  class BulkParcelJobParcel
    attr_accessor :integration_channel_parcel_id
    ...
    def self.attribute_map
      {
        :'integration_channel_parcel_id' => :'integrationChannelParcelId',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::BulkParcelJobParcel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::BulkParcelJobParcel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'integration_channel_parcel_id')
        self.integration_channel_parcel_id = attributes[:'integration_channel_parcel_id']
      else
        self.integration_channel_parcel_id = nil
      end
      ...
      if attributes.key?(:'parcel_status')
        self.parcel_status = attributes[:'parcel_status']
      else
        self.parcel_status = nil
      end

      if attributes.key?(:'error_messages')
        self.error_messages = attributes[:'error_messages']
      else
    ...
    def list_invalid_properties
      ...
      if @integration_channel_parcel_id.nil?
        invalid_properties.push('invalid value for "integration_channel_parcel_id", integration_channel_parcel_id cannot be nil.')
      end
      ...
      if @parcel_status.nil?
        invalid_properties.push('invalid value for "parcel_status", parcel_status cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          integration_channel_parcel_id == o.integration_channel_parcel_id &&
          tracking_number == o.tracking_number &&
          carrier_code == o.carrier_code &&
          ship_date == o.ship_date &&
          parcel_status == o.parcel_status &&
    ...
    def hash
      [integration_channel_parcel_id, tracking_number, carrier_code, ship_date, parcel_status, error_messages].hash
    end
