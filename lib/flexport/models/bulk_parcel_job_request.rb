...
module Flexport
  class BulkParcelJobRequest
    attr_accessor :parcels

    attr_accessor :packslip_required

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'parcels' => :'parcels',
        :'packslip_required' => :'packslipRequired'
      }
    end
    ...
    def self.openapi_types
      {
        :'parcels' => :'Array<BulkParcelRequest>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::BulkParcelJobRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::BulkParcelJobRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'packslip_required')
        self.packslip_required = attributes[:'packslip_required']
      else
        self.packslip_required = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @packslip_required.nil?
        invalid_properties.push('invalid value for "packslip_required", packslip_required cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @packslip_required.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          parcels == o.parcels &&
          packslip_required == o.packslip_required
    end
    ...
    def hash
      [parcels, packslip_required].hash
    end
