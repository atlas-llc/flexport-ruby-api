...
module Flexport
  class BulkParcelRequest
    ...
    attr_accessor :custom_label_footer_fields

    attr_accessor :customs_information

    attr_accessor :integration_channel

    attr_accessor :packslip_notes
    ...
    def self.attribute_map
      {
        ...
        :'custom_label_footer_fields' => :'customLabelFooterFields',
        :'customs_information' => :'customsInformation',
        :'integration_channel' => :'integrationChannel',
        :'packslip_notes' => :'packslipNotes'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'ship_to_address' => :'DeliverrAddress',
        :'return_address' => :'DeliverrAddress',
        :'skip_address_validation' => :'Boolean',
        :'pickup_date_time' => :'Time',
        :'dimensions' => :'ParcelDimensions',
        :'customer_custom_field' => :'String',
        :'label_format' => :'ShippingLabelFormatParcel',
        :'is_return' => :'Boolean',
        :'marketplace' => :'String',
        :'custom_label_footer_fields' => :'CustomLabelFooterFields',
        :'customs_information' => :'ParcelCustomsInformation',
        :'integration_channel' => :'String',
        :'packslip_notes' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::BulkParcelRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::BulkParcelRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'custom_label_footer_fields')
        self.custom_label_footer_fields = attributes[:'custom_label_footer_fields']
      end

      if attributes.key?(:'customs_information')
        self.customs_information = attributes[:'customs_information']
      end

      if attributes.key?(:'integration_channel')
        self.integration_channel = attributes[:'integration_channel']
      end

      if attributes.key?(:'packslip_notes')
        self.packslip_notes = attributes[:'packslip_notes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          custom_label_footer_fields == o.custom_label_footer_fields &&
          customs_information == o.customs_information &&
          integration_channel == o.integration_channel &&
          packslip_notes == o.packslip_notes
    end
    ...
    def hash
      [customer_parcel_id, service_level, injection_location, ship_to_address, return_address, skip_address_validation, pickup_date_time, dimensions, customer_custom_field, label_format, is_return, marketplace, custom_label_footer_fields, customs_information, integration_channel, packslip_notes].hash
    end
