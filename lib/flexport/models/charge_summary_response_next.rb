...
module Flexport
  class ChargeSummaryResponseNext
    ...
    def self.openapi_types
      {
        ...
        :'total' => :'Float',
        :'gross_total' => :'Float',
        :'charges' => :'ChargeSummaryResponseNextCharges'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ChargeSummaryResponseNext` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ChargeSummaryResponseNext`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gross_total')
        self.gross_total = attributes[:'gross_total']
      else
        self.gross_total = nil
      end
    ...
    def list_invalid_properties
      ...
      if @gross_total.nil?
        invalid_properties.push('invalid value for "gross_total", gross_total cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gross_total.nil?
    ...
    def hash
      [currency, total, gross_total, charges].hash
    end
