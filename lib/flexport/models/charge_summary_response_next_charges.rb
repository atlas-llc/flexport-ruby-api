...
module Flexport
  class ChargeSummaryResponseNextCharges
    ...
    def self.openapi_types
      {
        :'storage' => :'ChargeSummaryItem',
        :'inbound' => :'ChargeSummaryItem',
        :'returns' => :'ChargeSummaryItem',
        :'fulfillment' => :'ChargeSummaryItem',
        :'preparation' => :'ChargeSummaryItem',
        :'freight' => :'ChargeSummaryItem',
        :'parcel' => :'ChargeSummaryItem',
        :'special_projects' => :'ChargeSummaryItem',
        :'reserve_storage' => :'ChargeSummaryItem'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ChargeSummaryResponseNextCharges` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ChargeSummaryResponseNextCharges`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fulfillment')
        ...
        self.fulfillment = nil
      end

      if attributes.key?(:'preparation')
      ...
      if attributes.key?(:'special_projects')
        self.special_projects = attributes[:'special_projects']
      else
        self.special_projects = nil
      end

      if attributes.key?(:'reserve_storage')
        self.reserve_storage = attributes[:'reserve_storage']
      else
        self.reserve_storage = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @preparation.nil?
        invalid_properties.push('invalid value for "preparation", preparation cannot be nil.')
      end
      ...
      if @parcel.nil?
        invalid_properties.push('invalid value for "parcel", parcel cannot be nil.')
      end

      if @special_projects.nil?
        invalid_properties.push('invalid value for "special_projects", special_projects cannot be nil.')
      end

      if @reserve_storage.nil?
        invalid_properties.push('invalid value for "reserve_storage", reserve_storage cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @preparation.nil?
      return false if @freight.nil?
      return false if @parcel.nil?
      return false if @special_projects.nil?
      return false if @reserve_storage.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          freight == o.freight &&
          parcel == o.parcel &&
          special_projects == o.special_projects &&
          reserve_storage == o.reserve_storage
    end
    ...
    def hash
      [storage, inbound, returns, fulfillment, preparation, freight, parcel, special_projects, reserve_storage].hash
    end
