...
module Flexport
  class ChargeWorkUnitItem
    attr_accessor :network_ref_id

    attr_accessor :network_ref_type
    ...
    def self.attribute_map
      {
        ...
        :'network_ref_type' => :'networkRefType',
        :'charges' => :'charges'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ChargeWorkUnitItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ChargeWorkUnitItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'network_ref_id')
        self.network_ref_id = attributes[:'network_ref_id']
      else
        self.network_ref_id = nil
      end

      if attributes.key?(:'network_ref_type')
        self.network_ref_type = attributes[:'network_ref_type']
      else
        self.network_ref_type = nil
      end
    ...
    def list_invalid_properties
      ...
      if @network_ref_id.nil?
        invalid_properties.push('invalid value for "network_ref_id", network_ref_id cannot be nil.')
      end

      if @network_ref_type.nil?
        invalid_properties.push('invalid value for "network_ref_type", network_ref_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @network_ref_id.nil?
      return false if @network_ref_type.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          network_ref_id == o.network_ref_id &&
          network_ref_type == o.network_ref_type &&
          charges == o.charges
    end
    ...
    def hash
      [network_ref_id, network_ref_type, charges].hash
    end
