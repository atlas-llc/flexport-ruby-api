...
module Flexport
  # Response from creating or updating a channel
  class CreateChannelOutput
    # Unique UUID for this channel
    attr_accessor :channel_id

    # Name of the authorized store that will be used to access a Channel's API E.g. shop1.myshopify.com
    attr_accessor :store_name

    # Name of the channel E.g. SHOPIFY
    attr_accessor :channel_type

    # The URL where fulfillment requests should be sent to
    attr_accessor :fulfillment_service_callback_url

    # The URL where webhook notifications should be registered to
    attr_accessor :webhook_callback_url
    ...
    def self.attribute_map
      {
        ...
        :'fulfillment_service_callback_url' => :'fulfillmentServiceCallbackUrl',
    ...
    def self.openapi_types
      {
        ...
        :'store_name' => :'String',
        :'channel_type' => :'String',
        :'fulfillment_service_callback_url' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::CreateChannelOutput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::CreateChannelOutput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fulfillment_service_callback_url')
        self.fulfillment_service_callback_url = attributes[:'fulfillment_service_callback_url']
      else
        self.fulfillment_service_callback_url = nil
      end

      if attributes.key?(:'webhook_callback_url')
        self.webhook_callback_url = attributes[:'webhook_callback_url']
      else
        self.webhook_callback_url = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @fulfillment_service_callback_url.nil?
        invalid_properties.push('invalid value for "fulfillment_service_callback_url", fulfillment_service_callback_url cannot be nil.')
      end

      if @webhook_callback_url.nil?
        invalid_properties.push('invalid value for "webhook_callback_url", webhook_callback_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fulfillment_service_callback_url.nil?
      return false if @webhook_callback_url.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fulfillment_service_callback_url == o.fulfillment_service_callback_url &&
          webhook_callback_url == o.webhook_callback_url
    end
    ...
    def hash
      [channel_id, store_name, channel_type, fulfillment_service_callback_url, webhook_callback_url].hash
    end
