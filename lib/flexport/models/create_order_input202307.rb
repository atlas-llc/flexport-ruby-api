...
module Flexport
  class CreateOrderInput202307
    ...
    attr_accessor :is_subscription_order

    attr_accessor :line_items

    attr_accessor :promised_delivery_by_time

    attr_accessor :promised_ship_by_time
    ...
    def self.attribute_map
      {
        ...
        :'promised_delivery_by_time' => :'promisedDeliveryByTime',
        :'promised_ship_by_time' => :'promisedShipByTime',
    ...
    def self.openapi_types
      {
        ...
        :'delivery_days' => :'Float',
        :'duties' => :'MaybeDutiesInput',
        :'external_order_id' => :'String',
        :'is_subscription_order' => :'Boolean',
        :'line_items' => :'Array<OrderLineItemInput>',
        :'promised_delivery_by_time' => :'Time',
        :'promised_ship_by_time' => :'Time',
        :'ship_method' => :'String',
        :'source' => :'MaybeSourceId'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::CreateOrderInput202307` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::CreateOrderInput202307`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_subscription_order')
        self.is_subscription_order = attributes[:'is_subscription_order']
      end
      ...
      if attributes.key?(:'promised_delivery_by_time')
        self.promised_delivery_by_time = attributes[:'promised_delivery_by_time']
      end

      if attributes.key?(:'promised_ship_by_time')
        self.promised_ship_by_time = attributes[:'promised_ship_by_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_subscription_order == o.is_subscription_order &&
          line_items == o.line_items &&
          promised_delivery_by_time == o.promised_delivery_by_time &&
          promised_ship_by_time == o.promised_ship_by_time &&
    ...
    def hash
      [address, delivery_days, duties, external_order_id, is_subscription_order, line_items, promised_delivery_by_time, promised_ship_by_time, ship_method, source].hash
    end
