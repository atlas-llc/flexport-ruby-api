...
module Flexport
  class CreateReturnRequest
    ...
    attr_accessor :external_label

    # Logistics ID of the original order, if available
    attr_accessor :logistics_order_id
    ...
    def self.openapi_types
      {
        ...
        :'return_items' => :'Array<RequestedReturnItem>',
        :'external_label' => :'ExternalLabel',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::CreateReturnRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::CreateReturnRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'external_label')
        self.external_label = attributes[:'external_label']
      end

      if attributes.key?(:'logistics_order_id')
        self.logistics_order_id = attributes[:'logistics_order_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_label == o.external_label &&
          logistics_order_id == o.logistics_order_id
    end
    ...
    def hash
      [rma, external_return_id, source_address, return_items, external_label, logistics_order_id].hash
    end
