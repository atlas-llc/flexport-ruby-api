...
module Flexport
  class CustomLabelFooterFields
    # A custom field that can be used to define a string to be placed in the footer of the shipping label.
    attr_accessor :custom_label_footer1

    # A custom field that can be used to define a string to be placed in the footer of the shipping label.
    attr_accessor :custom_label_footer2

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'custom_label_footer1' => :'customLabelFooter1',
        :'custom_label_footer2' => :'customLabelFooter2'
      }
    end
    ...
    def self.openapi_types
      {
        :'custom_label_footer1' => :'String',
        :'custom_label_footer2' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::CustomLabelFooterFields` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::CustomLabelFooterFields`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'custom_label_footer1')
        self.custom_label_footer1 = attributes[:'custom_label_footer1']
      else
        self.custom_label_footer1 = nil
      end

      if attributes.key?(:'custom_label_footer2')
        self.custom_label_footer2 = attributes[:'custom_label_footer2']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @custom_label_footer1.nil?
        invalid_properties.push('invalid value for "custom_label_footer1", custom_label_footer1 cannot be nil.')
      end

      if @custom_label_footer1.to_s.length > 25
        invalid_properties.push('invalid value for "custom_label_footer1", the character length must be smaller than or equal to 25.')
      end

      if @custom_label_footer1.to_s.length < 1
        invalid_properties.push('invalid value for "custom_label_footer1", the character length must be great than or equal to 1.')
      end

      if !@custom_label_footer2.nil? && @custom_label_footer2.to_s.length > 25
        invalid_properties.push('invalid value for "custom_label_footer2", the character length must be smaller than or equal to 25.')
      end

      if !@custom_label_footer2.nil? && @custom_label_footer2.to_s.length < 1
        invalid_properties.push('invalid value for "custom_label_footer2", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @custom_label_footer1.nil?
      return false if @custom_label_footer1.to_s.length > 25
      return false if @custom_label_footer1.to_s.length < 1
      return false if !@custom_label_footer2.nil? && @custom_label_footer2.to_s.length > 25
      return false if !@custom_label_footer2.nil? && @custom_label_footer2.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] custom_label_footer1 Value to be assigned
    def custom_label_footer1=(custom_label_footer1)
      if custom_label_footer1.nil?
        fail ArgumentError, 'custom_label_footer1 cannot be nil'
      end

      if custom_label_footer1.to_s.length > 25
        fail ArgumentError, 'invalid value for "custom_label_footer1", the character length must be smaller than or equal to 25.'
      end

      if custom_label_footer1.to_s.length < 1
        fail ArgumentError, 'invalid value for "custom_label_footer1", the character length must be great than or equal to 1.'
      end

      @custom_label_footer1 = custom_label_footer1
    end

    # Custom attribute writer method with validation
    # @param [Object] custom_label_footer2 Value to be assigned
    def custom_label_footer2=(custom_label_footer2)
      if custom_label_footer2.nil?
        fail ArgumentError, 'custom_label_footer2 cannot be nil'
      end

      if custom_label_footer2.to_s.length > 25
        fail ArgumentError, 'invalid value for "custom_label_footer2", the character length must be smaller than or equal to 25.'
      end

      if custom_label_footer2.to_s.length < 1
        fail ArgumentError, 'invalid value for "custom_label_footer2", the character length must be great than or equal to 1.'
      end

      @custom_label_footer2 = custom_label_footer2
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          custom_label_footer1 == o.custom_label_footer1 &&
          custom_label_footer2 == o.custom_label_footer2
    end
    ...
    def hash
      [custom_label_footer1, custom_label_footer2].hash
    end
