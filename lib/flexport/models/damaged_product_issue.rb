...
module Flexport
  class DamagedProductIssue
    # Describes the type of damage to the products
    attr_accessor :damage_type

    # Who is responsible for the damage
    attr_accessor :damage_fault

    # URL for image
    attr_accessor :damaged_exterior_photo

    # URL for image
    attr_accessor :damaged_product_photo

    # URL for image
    attr_accessor :additional_photo1

    # URL for image
    attr_accessor :additional_photo2

    # Whether the product has been disposed
    attr_accessor :disposal_status
    ...
    def self.openapi_types
      {
        :'damage_type' => :'DamageType',
        :'damage_fault' => :'DamageFault',
        :'damaged_exterior_photo' => :'Object',
        :'damaged_product_photo' => :'Object',
        :'additional_photo1' => :'Object',
        :'additional_photo2' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::DamagedProductIssue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::DamagedProductIssue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'damage_type')
        self.damage_type = attributes[:'damage_type']
      else
        self.damage_type = nil
      end

      if attributes.key?(:'damage_fault')
        self.damage_fault = attributes[:'damage_fault']
      else
        self.damage_fault = nil
      end

      if attributes.key?(:'damaged_exterior_photo')
        self.damaged_exterior_photo = attributes[:'damaged_exterior_photo']
      end

      if attributes.key?(:'damaged_product_photo')
        self.damaged_product_photo = attributes[:'damaged_product_photo']
      end

      if attributes.key?(:'additional_photo1')
        self.additional_photo1 = attributes[:'additional_photo1']
      end

      if attributes.key?(:'additional_photo2')
        self.additional_photo2 = attributes[:'additional_photo2']
      end

      if attributes.key?(:'disposal_status')
        self.disposal_status = attributes[:'disposal_status']
      else
        self.disposal_status = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @damage_type.nil?
        invalid_properties.push('invalid value for "damage_type", damage_type cannot be nil.')
      end

      if @damage_fault.nil?
        invalid_properties.push('invalid value for "damage_fault", damage_fault cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @damage_type.nil?
      return false if @damage_fault.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          damage_fault == o.damage_fault &&
          damaged_exterior_photo == o.damaged_exterior_photo &&
          damaged_product_photo == o.damaged_product_photo &&
          additional_photo1 == o.additional_photo1 &&
          additional_photo2 == o.additional_photo2 &&
          disposal_status == o.disposal_status
    end
    ...
    def hash
      [damage_type, damage_fault, damaged_exterior_photo, damaged_product_photo, additional_photo1, additional_photo2, disposal_status].hash
    end
