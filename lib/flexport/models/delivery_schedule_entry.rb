  ...
  class DeliveryScheduleEntry
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::DeliveryScheduleEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::DeliveryScheduleEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subdivision_code')
        self.subdivision_code = attributes[:'subdivision_code']
      else
        self.subdivision_code = nil
      end
    ...
    def list_invalid_properties
      ...
      if @subdivision_code.nil?
        invalid_properties.push('invalid value for "subdivision_code", subdivision_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subdivision_code.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subdivision_code == o.subdivision_code &&
    ...
    def hash
      [country_code, subdivision_code, postal_code, min_delivery_date, max_delivery_date, expiration_date].hash
    end
