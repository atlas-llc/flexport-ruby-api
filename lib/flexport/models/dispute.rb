...
module Flexport
  class Dispute
    # The issue has an open dispute
    attr_accessor :has_active_dispute

    # URL for the dispute ticket
    attr_accessor :dispute_url

    # When the dispute was closed
    attr_accessor :dispute_closed_at
    ...
    def self.attribute_map
      {
        ...
        :'dispute_closed_at' => :'disputeClosedAt'
      }
    end
    ...
    def self.openapi_types
      {
        :'has_active_dispute' => :'Object',
        :'dispute_url' => :'Object',
        :'dispute_closed_at' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::Dispute` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::Dispute`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'has_active_dispute')
        self.has_active_dispute = attributes[:'has_active_dispute']
      end

      if attributes.key?(:'dispute_url')
        self.dispute_url = attributes[:'dispute_url']
      end

      if attributes.key?(:'dispute_closed_at')
        self.dispute_closed_at = attributes[:'dispute_closed_at']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          has_active_dispute == o.has_active_dispute &&
          dispute_url == o.dispute_url &&
          dispute_closed_at == o.dispute_closed_at
    end
    ...
    def hash
      [has_active_dispute, dispute_url, dispute_closed_at].hash
    end
