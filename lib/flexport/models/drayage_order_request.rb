...
module Flexport
  class DrayageOrderRequest
    attr_accessor :commodity_description
    ...
    # The returned S3 object key from using the Uploads API to upload the delivery order document.
    attr_accessor :delivery_order_document_key

    attr_accessor :master_bol_id

    attr_accessor :package_type

    attr_accessor :packages

    # The returned S3 object key from using the Uploads API to upload the packing list document.
    attr_accessor :packing_list_document_key

    # The ID of the pickup Port, obtainable via the \"Get all ports\" endpoint.
    ...
    def self.attribute_map
      {
        ...
        :'delivery_order_document_key' => :'deliveryOrderDocumentKey',
        :'master_bol_id' => :'masterBolId',
        :'package_type' => :'packageType',
        :'packages' => :'packages',
        :'packing_list_document_key' => :'packingListDocumentKey',
        :'port_id' => :'portId',
        :'quote_id' => :'quoteId'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'delivery_order_document_key' => :'String',
        :'master_bol_id' => :'String',
        :'package_type' => :'PackageType',
        :'packages' => :'Array<PackageDetails>',
        :'packing_list_document_key' => :'String',
        :'port_id' => :'String',
        :'quote_id' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::DrayageOrderRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::DrayageOrderRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'commodity_description')
        self.commodity_description = attributes[:'commodity_description']
      end
      ...
      if attributes.key?(:'customer_reference_number')
        self.customer_reference_number = attributes[:'customer_reference_number']
      end

      if attributes.key?(:'delivery_details')
        self.delivery_details = attributes[:'delivery_details']
      else
        self.delivery_details = nil
      end

      if attributes.key?(:'delivery_order_document_key')
        self.delivery_order_document_key = attributes[:'delivery_order_document_key']
      else
        self.delivery_order_document_key = nil
      end

      if attributes.key?(:'master_bol_id')
        self.master_bol_id = attributes[:'master_bol_id']
      else
        self.master_bol_id = nil
      end
      ...
      if attributes.key?(:'packing_list_document_key')
        self.packing_list_document_key = attributes[:'packing_list_document_key']
      else
        self.packing_list_document_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @delivery_details.nil?
        invalid_properties.push('invalid value for "delivery_details", delivery_details cannot be nil.')
      end

      if @delivery_order_document_key.nil?
        invalid_properties.push('invalid value for "delivery_order_document_key", delivery_order_document_key cannot be nil.')
      end

      if @master_bol_id.nil?
        invalid_properties.push('invalid value for "master_bol_id", master_bol_id cannot be nil.')
      end

      if @packing_list_document_key.nil?
        invalid_properties.push('invalid value for "packing_list_document_key", packing_list_document_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @delivery_order_document_key.nil?
      return false if @master_bol_id.nil?
      return false if @packing_list_document_key.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          commodity_description == o.commodity_description &&
          container_id == o.container_id &&
          customer_reference_number == o.customer_reference_number &&
          delivery_details == o.delivery_details &&
          delivery_order_document_key == o.delivery_order_document_key &&
          master_bol_id == o.master_bol_id &&
          package_type == o.package_type &&
          packages == o.packages &&
          packing_list_document_key == o.packing_list_document_key &&
          port_id == o.port_id &&
          quote_id == o.quote_id
    end
    ...
    def hash
      [commodity_description, container_id, customer_reference_number, delivery_details, delivery_order_document_key, master_bol_id, package_type, packages, packing_list_document_key, port_id, quote_id].hash
    end
