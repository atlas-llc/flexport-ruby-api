...
module Flexport
  class DrayageOrderResponse
    ...
    attr_accessor :drayage_order_item

    attr_accessor :ftl_order_item
    ...
    attr_accessor :transload_order_item
    ...
    def self.attribute_map
      {
        ...
        :'drayage_order_item' => :'drayageOrderItem',
        :'ftl_order_item' => :'ftlOrderItem',
        :'id' => :'id',
        :'port_id' => :'portId',
        :'quote_id' => :'quoteId',
        :'status' => :'status',
        :'transload_order_item' => :'transloadOrderItem',
        :'type' => :'type'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'drayage_order_item' => :'DrayageOrderItemResponse',
        :'ftl_order_item' => :'FtlOrderItemResponse',
        :'id' => :'Float',
        :'port_id' => :'String',
        :'quote_id' => :'Float',
        :'status' => :'OrderStatus',
        :'transload_order_item' => :'TransloadOrderItemResponse',
        :'type' => :'FreightModeDRAYAGE'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::DrayageOrderResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::DrayageOrderResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'drayage_order_item')
        self.drayage_order_item = attributes[:'drayage_order_item']
      else
        self.drayage_order_item = nil
      end

      if attributes.key?(:'ftl_order_item')
        self.ftl_order_item = attributes[:'ftl_order_item']
      end
      ...
      if attributes.key?(:'transload_order_item')
        self.transload_order_item = attributes[:'transload_order_item']
      end
    ...
    def list_invalid_properties
      ...
      if @drayage_order_item.nil?
        invalid_properties.push('invalid value for "drayage_order_item", drayage_order_item cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @drayage_order_item.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          drayage_order_item == o.drayage_order_item &&
          ftl_order_item == o.ftl_order_item &&
          id == o.id &&
          port_id == o.port_id &&
          quote_id == o.quote_id &&
          status == o.status &&
          transload_order_item == o.transload_order_item &&
          type == o.type
    end
    ...
    def hash
      [commodity_description, created_at, customer_reference_number, delivery_details, drayage_order_item, ftl_order_item, id, port_id, quote_id, status, transload_order_item, type].hash
    end
