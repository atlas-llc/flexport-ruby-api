...
module Flexport
  class DrayageQuoteResponse
    ...
    attr_accessor :drayage_quote_item

    attr_accessor :transload_quote_item

    attr_accessor :ftl_quote_item
    ...
    def self.attribute_map
      {
        ...
        :'drayage_quote_item' => :'drayageQuoteItem',
        :'transload_quote_item' => :'transloadQuoteItem',
        :'ftl_quote_item' => :'ftlQuoteItem'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'pickup_details' => :'QuoteLocationDetails',
        :'delivery_details' => :'QuoteLocationDetails',
        :'id' => :'Float',
        :'created_at' => :'Time',
        :'status' => :'QuoteStatus',
        :'expires_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::DrayageQuoteResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::DrayageQuoteResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'drayage_quote_item')
        self.drayage_quote_item = attributes[:'drayage_quote_item']
      else
        self.drayage_quote_item = nil
      end

      if attributes.key?(:'transload_quote_item')
        self.transload_quote_item = attributes[:'transload_quote_item']
      end

      if attributes.key?(:'ftl_quote_item')
        self.ftl_quote_item = attributes[:'ftl_quote_item']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @drayage_quote_item.nil?
        invalid_properties.push('invalid value for "drayage_quote_item", drayage_quote_item cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @drayage_quote_item.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          drayage_quote_item == o.drayage_quote_item &&
          transload_quote_item == o.transload_quote_item &&
          ftl_quote_item == o.ftl_quote_item
    end
    ...
    def hash
      [type, pickup_details, delivery_details, id, created_at, status, expires_at, drayage_quote_item, transload_quote_item, ftl_quote_item].hash
    end
