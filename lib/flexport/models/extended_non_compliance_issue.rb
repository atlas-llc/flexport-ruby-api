...
module Flexport
  # This type contains any issue type specific data. Only one property in this object will be set per issue
  class ExtendedNonComplianceIssue
    attr_accessor :missing_barcode

    attr_accessor :unknown_barcode

    attr_accessor :unexpected_sku

    attr_accessor :damaged_product

    attr_accessor :relabeled_box

    attr_accessor :short_shipped_box
    ...
    def self.attribute_map
      {
        ...
        :'relabeled_box' => :'relabeledBox',
        :'short_shipped_box' => :'shortShippedBox'
      }
    end
    ...
    def self.openapi_types
      {
        :'missing_barcode' => :'MissingBarcodeIssue',
        :'unknown_barcode' => :'UnknownBarcodeIssue',
        :'unexpected_sku' => :'Hash<String, Object>',
        :'damaged_product' => :'DamagedProductIssue',
        :'relabeled_box' => :'RelabeledBoxIssue',
        :'short_shipped_box' => :'ShortShippedBoxIssue'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ExtendedNonComplianceIssue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ExtendedNonComplianceIssue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'missing_barcode')
        self.missing_barcode = attributes[:'missing_barcode']
      end

      if attributes.key?(:'unknown_barcode')
        self.unknown_barcode = attributes[:'unknown_barcode']
      end

      if attributes.key?(:'unexpected_sku')
      end

      if attributes.key?(:'damaged_product')
        self.damaged_product = attributes[:'damaged_product']
      end

      if attributes.key?(:'relabeled_box')
        self.relabeled_box = attributes[:'relabeled_box']
      end

      if attributes.key?(:'short_shipped_box')
        self.short_shipped_box = attributes[:'short_shipped_box']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          missing_barcode == o.missing_barcode &&
          unknown_barcode == o.unknown_barcode &&
          unexpected_sku == o.unexpected_sku &&
          damaged_product == o.damaged_product &&
          relabeled_box == o.relabeled_box &&
          short_shipped_box == o.short_shipped_box
    end
    ...
    def hash
      [missing_barcode, unknown_barcode, unexpected_sku, damaged_product, relabeled_box, short_shipped_box].hash
    end
