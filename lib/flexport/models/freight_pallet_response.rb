...
module Flexport
  class FreightPalletResponse
    attr_accessor :id

    attr_accessor :pallet_config_id
    ...
    def self.attribute_map
      {
        :'id' => :'id',
        :'pallet_config_id' => :'palletConfigId',
        :'length' => :'length',
        :'width' => :'width',
        :'height' => :'height',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::FreightPalletResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::FreightPalletResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pallet_config_id')
        self.pallet_config_id = attributes[:'pallet_config_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          pallet_config_id == o.pallet_config_id &&
          length == o.length &&
          width == o.width &&
          height == o.height &&
    ...
    def hash
      [id, pallet_config_id, length, width, height, dimension_unit, weight, weight_unit].hash
    end
