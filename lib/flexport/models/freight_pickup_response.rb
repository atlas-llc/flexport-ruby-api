...
module Flexport
  class FreightPickupResponse
    ...
    attr_accessor :facility_operating_hours
    ...
    def self.attribute_map
      {
        ...
        :'facility_operating_hours' => :'facilityOperatingHours'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'facility_operating_hours' => :'TimeWindow'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::FreightPickupResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::FreightPickupResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'facility_operating_hours')
        self.facility_operating_hours = attributes[:'facility_operating_hours']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          facility_operating_hours == o.facility_operating_hours
    end
    ...
    def hash
      [id, contact_name, contact_phone, contact_email, lift_gate, pickup_date, customer_reference_number, facility_operating_hours].hash
    end
