...
module Flexport
  class FreightStopDetails
    attr_accessor :appointment_window
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::FreightStopDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::FreightStopDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'appointment_window')
        self.appointment_window = attributes[:'appointment_window']
      else
        self.appointment_window = nil
      end
    ...
    def list_invalid_properties
      ...
      if @appointment_window.nil?
        invalid_properties.push('invalid value for "appointment_window", appointment_window cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @appointment_window.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          appointment_window == o.appointment_window &&
          address == o.address
    end
    ...
    def hash
      [appointment_window, address].hash
    end
