...
module Flexport
  # Represents a fulfillment package.
  class FulfillmentPackage
    attr_accessor :attempted_delivery_time

    attr_accessor :carrier_delivery_time

    attr_accessor :carrier_pick_up_time

    attr_accessor :carrier_ship_time
    ...
    attr_accessor :label_create_time
    ...
    def self.attribute_map
      {
        ...
        :'carrier_delivery_time' => :'carrierDeliveryTime',
        :'carrier_pick_up_time' => :'carrierPickUpTime',
        :'carrier_ship_time' => :'carrierShipTime',
        :'created_at' => :'createdAt',
        :'id' => :'id',
        :'label' => :'label',
        :'label_create_time' => :'labelCreateTime',
    ...
    def self.openapi_types
      {
        ...
        :'carrier_delivery_time' => :'Time',
        :'carrier_pick_up_time' => :'Time',
        :'carrier_ship_time' => :'Time',
        :'created_at' => :'Time',
        :'id' => :'String',
        :'label' => :'MaybePackageLabel',
        :'label_create_time' => :'Time',
        :'line_items' => :'Array<FulfillmentPackageItem>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::FulfillmentPackage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::FulfillmentPackage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'carrier_delivery_time')
        self.carrier_delivery_time = attributes[:'carrier_delivery_time']
      end

      if attributes.key?(:'carrier_pick_up_time')
        self.carrier_pick_up_time = attributes[:'carrier_pick_up_time']
      end

      if attributes.key?(:'carrier_ship_time')
        self.carrier_ship_time = attributes[:'carrier_ship_time']
      end
      ...
      if attributes.key?(:'label_create_time')
        self.label_create_time = attributes[:'label_create_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          carrier_delivery_time == o.carrier_delivery_time &&
          carrier_pick_up_time == o.carrier_pick_up_time &&
          carrier_ship_time == o.carrier_ship_time &&
          created_at == o.created_at &&
          id == o.id &&
          label == o.label &&
          label_create_time == o.label_create_time &&
    ...
    def hash
      [attempted_delivery_time, carrier_delivery_time, carrier_pick_up_time, carrier_ship_time, created_at, id, label, label_create_time, line_items].hash
    end
