...
module Flexport
  class FulfillmentShipmentObject
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::FulfillmentShipmentObject` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::FulfillmentShipmentObject`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      shipping_carrier_validator = EnumAttributeValidator.new('String', ["USPS", "FEDEX", "UPS", "DHL", "DOORDASH", "ONTRAC", "LASERSHIP", "LSO", "PCF", "AXLEHIRE", "FREIGHT", "COURIER", "BETTERTRUCKS", "TFORCE", "UDS", "CDL", "DELIVERR", "GLS"])
      return false unless shipping_carrier_validator.valid?(@shipping_carrier)
      shipping_service_validator = EnumAttributeValidator.new('String', ["USPS.PRIORITY", "USPS.EXPRESS.MAIL", "USPS.FIRST.CLASS.MAIL", "USPS.PARCEL.SELECT.NONPRESORT", "USPS.MEDIA.MAIL.SINGLEPIECE", "USPS.FIRST.CLASS.MAIL.INTERNATIONAL", "USPS.PRIORITY.MAIL.INTERNATIONAL", "USPS.EXPRESS.MAIL.INTERNATIONAL", "FEDEX.GROUND", "FEDEX.GROUND.ECONOMY", "FEDEX.HOME.DELIVERY", "FEDEX.SMARTPOST.STANDARD", "FEDEX.2DAY.SHIPPING", "FEDEX.2DAY.AM.SHIPPING", "FEDEX.EXPRESS.SAVER.ECONOMY", "FEDEX.OVERNIGHT.STANDARD", "FEDEX.PRIORITY.OVERNIGHT", "FEDEX.INTERNATIONAL.ECONOMY", "FEDEX.INTERNATIONAL.PRIORITY", "FEDEX.FREIGHT.ECONOMY", "UPS.STANDARD", "UPS.GROUND", "UPS.3.DAY.SELECT", "UPS.2ND.DAY.AIR", "UPS.2ND.DAY.AIR.AM", "UPS.NEXT.DAY.AIR", "UPS.NEXT.DAY.AIR.SAVER", "UPS.NEXT.DAY.AIR.AM", "UPS.MAIL.INNOVATIONS", "UPS.SUREPOST", "UPS.SUREPOST.LIGHTWEIGHT", "UPS.WORLDWIDE.EXPRESS", "UPS.WORLDWIDE.EXPRESS.PLUS", "UPS.WORLDWIDE.EXPEDITED", "DHL.EXPRESS.WORLDWIDE", "DHL.PARCEL.EXP.MAX", "DHL.PARCEL.PLUS.EXP.MAX", "DHL.PARCEL.EXP.MAX.ATL", "DHL.PARCEL.PLUS.EXP.MAX.ATL", "DHL.PARCEL.EXP.MAX.BWI", "DHL.PARCEL.PLUS.EXP.MAX.BWI", "DHL.PARCEL.EXP.MAX.CVG", "DHL.PARCEL.PLUS.EXP.MAX.CVG", "DHL.PARCEL.EXP.MAX.LAX", "DHL.PARCEL.PLUS.EXP.MAX.LAX", "DHL.PARCEL.EXP.MAX.DFW", "DHL.PARCEL.PLUS.EXP.MAX.DFW", "DHL.PARCEL.EXP.MAX.ORD", "DHL.PARCEL.PLUS.EXP.MAX.ORD", "DHL.PARCEL.EXP.MAX.EWR", "DHL.PARCEL.PLUS.EXP.MAX.EWR", "DHL.PARCEL.EXP.MAX.RDU", "DHL.PARCEL.PLUS.EXP.MAX.RDU", "DHL.PARCEL.EXP.MAX.SFO", "DHL.PARCEL.PLUS.EXP.MAX.SFO", "DHL.PARCEL.EXP", "DHL.PARCEL.PLUS.EXP", "DHL.PARCEL.GROUND", "DHL.PARCEL.INTERNATIONAL.DIRECT", "DHL.PARCEL.INTERNATIONAL.STANDARD", "DHL.PACKET.INTERNATIONAL", "DOORDASH.NEXT.DAY", "DOORDASH.SAME.DAY", "ONTRAC.GROUND", "ONTRAC.GROUND.BEN", "ONTRAC.GROUND.LAS", "ONTRAC.GROUND.LAX", "ONTRAC.GROUND.RNO", "LASERSHIP.ROUTED.DELIVERY", "LASERSHIP.ROUTED.DELIVERY.CLT", "LASERSHIP.ROUTED.DELIVERY.MCO", "LASERSHIP.ROUTED.DELIVERY.EWR", "LASERSHIP.ROUTED.DELIVERY.LCK", "LSO.GROUND", "LSO.GROUND.DFW", "LSO.ECOMM", "PCF.STANDARD", "PCF.2ND.DAY", "AXLEHIRE.NEXT.DAY", "FREIGHT.LTL", "COURIER.PICKUP", "BETTERTRUCKS.SAME.DAY", "BETTERTRUCKS.EXPRESS", "BETTERTRUCKS.ECONOMY", "TFORCE.SAME.DAY", "TFORCE.NEXT.DAY", "TFORCE.BOND.STANDARD", "UDS.DELIVERY.SERVICE", "CDL.SAME.DAY", "CDL.NEXT.DAY", "DELIVERR.SHIPPING", "GLS.GROUND", "GLS.PRIORITY", "GLS.EARLY.PRIORITY"])
      return false unless shipping_service_validator.valid?(@shipping_service)
      true
    end
    ...
    def shipping_carrier=(shipping_carrier)
      validator = EnumAttributeValidator.new('String', ["USPS", "FEDEX", "UPS", "DHL", "DOORDASH", "ONTRAC", "LASERSHIP", "LSO", "PCF", "AXLEHIRE", "FREIGHT", "COURIER", "BETTERTRUCKS", "TFORCE", "UDS", "CDL", "DELIVERR", "GLS"])
      unless validator.valid?(shipping_carrier)
        fail ArgumentError, "invalid value for \"shipping_carrier\", must be one of #{validator.allowable_values}."
      end
      @shipping_carrier = shipping_carrier
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] shipping_service Object to be assigned
    def shipping_service=(shipping_service)
      validator = EnumAttributeValidator.new('String', ["USPS.PRIORITY", "USPS.EXPRESS.MAIL", "USPS.FIRST.CLASS.MAIL", "USPS.PARCEL.SELECT.NONPRESORT", "USPS.MEDIA.MAIL.SINGLEPIECE", "USPS.FIRST.CLASS.MAIL.INTERNATIONAL", "USPS.PRIORITY.MAIL.INTERNATIONAL", "USPS.EXPRESS.MAIL.INTERNATIONAL", "FEDEX.GROUND", "FEDEX.GROUND.ECONOMY", "FEDEX.HOME.DELIVERY", "FEDEX.SMARTPOST.STANDARD", "FEDEX.2DAY.SHIPPING", "FEDEX.2DAY.AM.SHIPPING", "FEDEX.EXPRESS.SAVER.ECONOMY", "FEDEX.OVERNIGHT.STANDARD", "FEDEX.PRIORITY.OVERNIGHT", "FEDEX.INTERNATIONAL.ECONOMY", "FEDEX.INTERNATIONAL.PRIORITY", "FEDEX.FREIGHT.ECONOMY", "UPS.STANDARD", "UPS.GROUND", "UPS.3.DAY.SELECT", "UPS.2ND.DAY.AIR", "UPS.2ND.DAY.AIR.AM", "UPS.NEXT.DAY.AIR", "UPS.NEXT.DAY.AIR.SAVER", "UPS.NEXT.DAY.AIR.AM", "UPS.MAIL.INNOVATIONS", "UPS.SUREPOST", "UPS.SUREPOST.LIGHTWEIGHT", "UPS.WORLDWIDE.EXPRESS", "UPS.WORLDWIDE.EXPRESS.PLUS", "UPS.WORLDWIDE.EXPEDITED", "DHL.EXPRESS.WORLDWIDE", "DHL.PARCEL.EXP.MAX", "DHL.PARCEL.PLUS.EXP.MAX", "DHL.PARCEL.EXP.MAX.ATL", "DHL.PARCEL.PLUS.EXP.MAX.ATL", "DHL.PARCEL.EXP.MAX.BWI", "DHL.PARCEL.PLUS.EXP.MAX.BWI", "DHL.PARCEL.EXP.MAX.CVG", "DHL.PARCEL.PLUS.EXP.MAX.CVG", "DHL.PARCEL.EXP.MAX.LAX", "DHL.PARCEL.PLUS.EXP.MAX.LAX", "DHL.PARCEL.EXP.MAX.DFW", "DHL.PARCEL.PLUS.EXP.MAX.DFW", "DHL.PARCEL.EXP.MAX.ORD", "DHL.PARCEL.PLUS.EXP.MAX.ORD", "DHL.PARCEL.EXP.MAX.EWR", "DHL.PARCEL.PLUS.EXP.MAX.EWR", "DHL.PARCEL.EXP.MAX.RDU", "DHL.PARCEL.PLUS.EXP.MAX.RDU", "DHL.PARCEL.EXP.MAX.SFO", "DHL.PARCEL.PLUS.EXP.MAX.SFO", "DHL.PARCEL.EXP", "DHL.PARCEL.PLUS.EXP", "DHL.PARCEL.GROUND", "DHL.PARCEL.INTERNATIONAL.DIRECT", "DHL.PARCEL.INTERNATIONAL.STANDARD", "DHL.PACKET.INTERNATIONAL", "DOORDASH.NEXT.DAY", "DOORDASH.SAME.DAY", "ONTRAC.GROUND", "ONTRAC.GROUND.BEN", "ONTRAC.GROUND.LAS", "ONTRAC.GROUND.LAX", "ONTRAC.GROUND.RNO", "LASERSHIP.ROUTED.DELIVERY", "LASERSHIP.ROUTED.DELIVERY.CLT", "LASERSHIP.ROUTED.DELIVERY.MCO", "LASERSHIP.ROUTED.DELIVERY.EWR", "LASERSHIP.ROUTED.DELIVERY.LCK", "LSO.GROUND", "LSO.GROUND.DFW", "LSO.ECOMM", "PCF.STANDARD", "PCF.2ND.DAY", "AXLEHIRE.NEXT.DAY", "FREIGHT.LTL", "COURIER.PICKUP", "BETTERTRUCKS.SAME.DAY", "BETTERTRUCKS.EXPRESS", "BETTERTRUCKS.ECONOMY", "TFORCE.SAME.DAY", "TFORCE.NEXT.DAY", "TFORCE.BOND.STANDARD", "UDS.DELIVERY.SERVICE", "CDL.SAME.DAY", "CDL.NEXT.DAY", "DELIVERR.SHIPPING", "GLS.GROUND", "GLS.PRIORITY", "GLS.EARLY.PRIORITY"])
      unless validator.valid?(shipping_service)
        fail ArgumentError, "invalid value for \"shipping_service\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [shipping_carrier, shipping_service].hash
    end
