...
module Flexport
  class InboundRateQuoteFE
    attr_accessor :shipping_option

    attr_accessor :rate_shopping_method

    attr_accessor :amount

    attr_accessor :full_amount

    attr_accessor :currency

    attr_accessor :shipping_provider

    attr_accessor :provider_method

    attr_accessor :external_estimate_days

    attr_accessor :external_eta
    ...
    def self.attribute_map
      {
        ...
        :'rate_shopping_method' => :'rateShoppingMethod',
        :'amount' => :'amount',
        :'full_amount' => :'fullAmount',
        :'currency' => :'currency',
        :'shipping_provider' => :'shippingProvider',
        :'provider_method' => :'providerMethod',
        :'external_estimate_days' => :'externalEstimateDays',
        :'external_eta' => :'externalEta',
        :'id' => :'id'
      }
    end
    ...
    def self.openapi_types
      {
        :'shipping_option' => :'NetworkInboundShippingOption',
        :'rate_shopping_method' => :'InboundRateShoppingMethod',
        :'amount' => :'Float',
        :'full_amount' => :'Float',
        :'currency' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::InboundRateQuoteFE` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::InboundRateQuoteFE`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rate_shopping_method')
        self.rate_shopping_method = attributes[:'rate_shopping_method']
      else
        self.rate_shopping_method = nil
      end
      ...
      if attributes.key?(:'full_amount')
        self.full_amount = attributes[:'full_amount']
      end
      ...
      if attributes.key?(:'shipping_provider')
        self.shipping_provider = attributes[:'shipping_provider']
      else
        self.shipping_provider = nil
      end

      if attributes.key?(:'provider_method')
        self.provider_method = attributes[:'provider_method']
      else
        self.provider_method = nil
      end

      if attributes.key?(:'external_estimate_days')
        self.external_estimate_days = attributes[:'external_estimate_days']
      else
        self.external_estimate_days = nil
      end

      if attributes.key?(:'external_eta')
        self.external_eta = attributes[:'external_eta']
      else
        self.external_eta = nil
      end
    ...
    def list_invalid_properties
      ...
      if @shipping_option.nil?
        invalid_properties.push('invalid value for "shipping_option", shipping_option cannot be nil.')
      end

      if @rate_shopping_method.nil?
        invalid_properties.push('invalid value for "rate_shopping_method", rate_shopping_method cannot be nil.')
      end
      ...
      if @shipping_provider.nil?
        invalid_properties.push('invalid value for "shipping_provider", shipping_provider cannot be nil.')
      end

      if @provider_method.nil?
        invalid_properties.push('invalid value for "provider_method", provider_method cannot be nil.')
      end

      if @external_estimate_days.nil?
        invalid_properties.push('invalid value for "external_estimate_days", external_estimate_days cannot be nil.')
      end

      if @external_eta.nil?
        invalid_properties.push('invalid value for "external_eta", external_eta cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @shipping_option.nil?
      return false if @rate_shopping_method.nil?
      return false if @amount.nil?
      return false if @currency.nil?
      return false if @shipping_provider.nil?
      return false if @provider_method.nil?
      return false if @external_estimate_days.nil?
      return false if @external_eta.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rate_shopping_method == o.rate_shopping_method &&
          amount == o.amount &&
          full_amount == o.full_amount &&
          currency == o.currency &&
          shipping_provider == o.shipping_provider &&
          provider_method == o.provider_method &&
          external_estimate_days == o.external_estimate_days &&
          external_eta == o.external_eta &&
          id == o.id
    end
    ...
    def hash
      [shipping_option, rate_shopping_method, amount, full_amount, currency, shipping_provider, provider_method, external_estimate_days, external_eta, id].hash
    end
