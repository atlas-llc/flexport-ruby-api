  ...
  class InboundReceivedEvent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::InboundReceivedEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::InboundReceivedEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipment_item_id')
        self.shipment_item_id = attributes[:'shipment_item_id']
      else
        self.shipment_item_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @shipment_item_id.nil?
        invalid_properties.push('invalid value for "shipment_item_id", shipment_item_id cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('Object', ["SELLABLE"])
      return false unless type_validator.valid?(@type)
      return false if @amount.nil?
      return false if @shipment_item_id.nil?
      true
    end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ["SELLABLE"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          amount == o.amount &&
          shipment_item_id == o.shipment_item_id
    end
    ...
    def hash
      [logistics_account_id, logistics_event_id, logistics_event_type, logistics_event_time, type, amount, shipment_item_id].hash
    end
