...
module Flexport
  class InboundShipmentResponseV4
    attr_accessor :id

    attr_accessor :receiving_id
    ...
    attr_accessor :shipping_plan_external_id
    ...
    def self.attribute_map
      {
        ...
        :'shipping_plan_external_id' => :'shippingPlanExternalId',
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'receiving_id' => :'String',
        :'status' => :'LogisticsInboundShipmentStatus',
        :'addresses' => :'AddressesOutput',
        :'items' => :'Array<ItemOutputUnstable>',
        :'packages' => :'Array<PackageOutputUnstable>',
        :'arrived_at' => :'Time',
        :'completed_at' => :'Time',
        :'freight' => :'ShopifyFreightResponse',
        :'prep' => :'PrepRequestData',
        :'shipping_plan_id' => :'String',
        :'shipping_plan_external_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::InboundShipmentResponseV4` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::InboundShipmentResponseV4`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'receiving_id')
        self.receiving_id = attributes[:'receiving_id']
      else
        self.receiving_id = nil
      end
      ...
      if attributes.key?(:'arrived_at')
        self.arrived_at = attributes[:'arrived_at']
      end
      ...
      if attributes.key?(:'shipping_plan_id')
        ...
        self.shipping_plan_id = nil
      end

      if attributes.key?(:'shipping_plan_external_id')
        self.shipping_plan_external_id = attributes[:'shipping_plan_external_id']
      end
    ...
    def list_invalid_properties
      ...
      if @receiving_id.nil?
        invalid_properties.push('invalid value for "receiving_id", receiving_id cannot be nil.')
      end
      ...
      if @prep.nil?
        invalid_properties.push('invalid value for "prep", prep cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @receiving_id.nil?
      return false if @status.nil?
      return false if @addresses.nil?
      return false if @prep.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_plan_external_id == o.shipping_plan_external_id &&
    ...
    def hash
      [id, receiving_id, status, addresses, items, packages, arrived_at, completed_at, freight, prep, shipping_plan_id, shipping_plan_external_id, shipping_plan_name].hash
    end
