...
module Flexport
  class InspectedItem
    # The condition of the item when it was received at the warehouse.
    attr_accessor :received_condition

    # The condition of the item after any rework has been completed.
    attr_accessor :final_condition

    # The disposition applied to the item.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::InspectedItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::InspectedItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'received_condition')
        self.received_condition = attributes[:'received_condition']
      else
        self.received_condition = nil
      end

      if attributes.key?(:'final_condition')
        self.final_condition = attributes[:'final_condition']
      else
        self.final_condition = nil
      end
    ...
    def list_invalid_properties
      ...
      if @received_condition.nil?
        invalid_properties.push('invalid value for "received_condition", received_condition cannot be nil.')
      end

      if @final_condition.nil?
        invalid_properties.push('invalid value for "final_condition", final_condition cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @received_condition.nil?
      return false if @final_condition.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          received_condition == o.received_condition &&
    ...
    def hash
      [received_condition, final_condition, disposition].hash
    end
