...
module Flexport
  # The input fields used to create a logistics account.
  class LogisticsAccountCreateInput
    attr_accessor :experiment_code

    attr_accessor :is_sandbox_account

    attr_accessor :is_test_account

    # The Shopify Billing account ID.
    attr_accessor :shopify_billing_account_id
    ...
    def self.attribute_map
      {
        ...
        :'shopify_billing_account_id' => :'shopifyBillingAccountId'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'shopify_billing_account_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::LogisticsAccountCreateInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::LogisticsAccountCreateInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'experiment_code')
        self.experiment_code = attributes[:'experiment_code']
      end

      if attributes.key?(:'is_sandbox_account')
        self.is_sandbox_account = attributes[:'is_sandbox_account']
      end
      ...
      if attributes.key?(:'shopify_billing_account_id')
        self.shopify_billing_account_id = attributes[:'shopify_billing_account_id']
      else
        self.shopify_billing_account_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @shopify_billing_account_id.to_s.length > 255
        invalid_properties.push('invalid value for "shopify_billing_account_id", the character length must be smaller than or equal to 255.')
      end

      if @shopify_billing_account_id.to_s.length < 1
        invalid_properties.push('invalid value for "shopify_billing_account_id", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @shopify_billing_account_id.to_s.length > 255
      return false if @shopify_billing_account_id.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] shopify_billing_account_id Value to be assigned
    def shopify_billing_account_id=(shopify_billing_account_id)
      if !shopify_billing_account_id.nil? && shopify_billing_account_id.to_s.length > 255
        fail ArgumentError, 'invalid value for "shopify_billing_account_id", the character length must be smaller than or equal to 255.'
      end

      if !shopify_billing_account_id.nil? && shopify_billing_account_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "shopify_billing_account_id", the character length must be great than or equal to 1.'
      end

      @shopify_billing_account_id = shopify_billing_account_id
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          experiment_code == o.experiment_code &&
          is_sandbox_account == o.is_sandbox_account &&
          is_test_account == o.is_test_account &&
          shopify_billing_account_id == o.shopify_billing_account_id
    end
    ...
    def hash
      [experiment_code, is_sandbox_account, is_test_account, shopify_billing_account_id].hash
    end
