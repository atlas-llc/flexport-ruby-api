  ...
  class LtlQuoteResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::LtlQuoteResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::LtlQuoteResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ltl_quote_item')
        self.ltl_quote_item = attributes[:'ltl_quote_item']
      else
        self.ltl_quote_item = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ltl_quote_item.nil?
        invalid_properties.push('invalid value for "ltl_quote_item", ltl_quote_item cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ltl_quote_item.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ltl_quote_item == o.ltl_quote_item
    end
    ...
    def hash
      [type, pickup_details, delivery_details, id, created_at, status, expires_at, ltl_quote_item].hash
    end
