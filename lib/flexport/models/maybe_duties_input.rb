...
module Flexport
  class MaybeDutiesInput
    attr_accessor :incoterm

    # The merchant GUID associated with Global-E.
    attr_accessor :merchant_of_record_account_id

    attr_accessor :merchant_of_record_carrier_code

    # The merchant order ID associated with Global-E.
    attr_accessor :merchant_of_record_order_id

    # The merchant of record provider for the order.
    attr_accessor :merchant_of_record_provider

    attr_accessor :merchant_of_record_sku_map
    ...
    def self.attribute_map
      {
        :'incoterm' => :'incoterm',
        :'merchant_of_record_account_id' => :'merchantOfRecordAccountId',
        :'merchant_of_record_carrier_code' => :'merchantOfRecordCarrierCode',
        :'merchant_of_record_order_id' => :'merchantOfRecordOrderId',
        :'merchant_of_record_provider' => :'merchantOfRecordProvider',
        :'merchant_of_record_sku_map' => :'merchantOfRecordSkuMap'
      }
    end
    ...
    def self.openapi_types
      {
        :'incoterm' => :'MaybeIncoterm',
        :'merchant_of_record_account_id' => :'String',
        :'merchant_of_record_carrier_code' => :'String',
        :'merchant_of_record_order_id' => :'String',
        :'merchant_of_record_provider' => :'MerchantOfRecordProvider',
        :'merchant_of_record_sku_map' => :'Array<MaybeMerchantOfRecordSkuMapInput>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::MaybeDutiesInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::MaybeDutiesInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'incoterm')
        self.incoterm = attributes[:'incoterm']
      end

      if attributes.key?(:'merchant_of_record_account_id')
        self.merchant_of_record_account_id = attributes[:'merchant_of_record_account_id']
      else
        self.merchant_of_record_account_id = nil
      end

      if attributes.key?(:'merchant_of_record_carrier_code')
        self.merchant_of_record_carrier_code = attributes[:'merchant_of_record_carrier_code']
      end

      if attributes.key?(:'merchant_of_record_order_id')
        self.merchant_of_record_order_id = attributes[:'merchant_of_record_order_id']
      else
        self.merchant_of_record_order_id = nil
      end

      if attributes.key?(:'merchant_of_record_provider')
        self.merchant_of_record_provider = attributes[:'merchant_of_record_provider']
      else
        self.merchant_of_record_provider = nil
      end

      if attributes.key?(:'merchant_of_record_sku_map')
        if (value = attributes[:'merchant_of_record_sku_map']).is_a?(Array)
          self.merchant_of_record_sku_map = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @merchant_of_record_account_id.nil?
        invalid_properties.push('invalid value for "merchant_of_record_account_id", merchant_of_record_account_id cannot be nil.')
      end

      if @merchant_of_record_order_id.nil?
        invalid_properties.push('invalid value for "merchant_of_record_order_id", merchant_of_record_order_id cannot be nil.')
      end

      if @merchant_of_record_provider.nil?
        invalid_properties.push('invalid value for "merchant_of_record_provider", merchant_of_record_provider cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @merchant_of_record_account_id.nil?
      return false if @merchant_of_record_order_id.nil?
      return false if @merchant_of_record_provider.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          incoterm == o.incoterm &&
          merchant_of_record_account_id == o.merchant_of_record_account_id &&
          merchant_of_record_carrier_code == o.merchant_of_record_carrier_code &&
          merchant_of_record_order_id == o.merchant_of_record_order_id &&
          merchant_of_record_provider == o.merchant_of_record_provider &&
          merchant_of_record_sku_map == o.merchant_of_record_sku_map
    end
    ...
    def hash
      [incoterm, merchant_of_record_account_id, merchant_of_record_carrier_code, merchant_of_record_order_id, merchant_of_record_provider, merchant_of_record_sku_map].hash
    end
