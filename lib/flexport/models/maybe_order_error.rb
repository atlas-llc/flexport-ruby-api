...
module Flexport
  class MaybeOrderError
    attr_accessor :code

    attr_accessor :line_item_errors
    ...
    def self.openapi_types
      {
        :'code' => :'Float',
        :'line_item_errors' => :'Array<LineItemError>',
        :'message' => :'String',
        :'retriable' => :'Boolean',
        :'type' => :'OrderErrorType'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::MaybeOrderError` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::MaybeOrderError`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'line_item_errors')
        if (value = attributes[:'line_item_errors']).is_a?(Array)
          self.line_item_errors = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          code == o.code &&
          line_item_errors == o.line_item_errors &&
          message == o.message &&
    ...
    def hash
      [code, line_item_errors, message, retriable, type].hash
    end
