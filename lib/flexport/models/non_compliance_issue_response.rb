...
module Flexport
  class NonComplianceIssueResponse
    # Id of issue
    attr_accessor :id
    ...
    # Merchant's logistics product ID
    attr_accessor :logistics_sku

    # The shipment's barcode
    attr_accessor :barcode

    # The shipment id
    attr_accessor :shipment_id

    # The shipping plan id
    attr_accessor :shipping_plan_id

    # The total number of reported units
    attr_accessor :reported_units

    # The total number of received units
    attr_accessor :received_units
    ...
    # Wrapper for issue specific data
    ...
    def self.openapi_types
      {
        :'id' => :'Object',
        :'type' => :'NonComplianceIssueType',
        :'logistics_sku' => :'Object',
        :'barcode' => :'Object',
        :'shipment_id' => :'Object',
        :'shipping_plan_id' => :'Object',
        :'reported_units' => :'Object',
        :'received_units' => :'Object',
        :'status' => :'NonComplianceIssueStatus',
        :'created_at' => :'Object',
        :'updated_at' => :'Object',
        :'dispute' => :'Dispute',
        :'extended' => :'ExtendedNonComplianceIssue'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::NonComplianceIssueResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::NonComplianceIssueResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reported_units')
        self.reported_units = attributes[:'reported_units']
      end

      if attributes.key?(:'received_units')
        self.received_units = attributes[:'received_units']
      end
    ...
    def list_invalid_properties
      ...
      if @dispute.nil?
        invalid_properties.push('invalid value for "dispute", dispute cannot be nil.')
      end

      if @extended.nil?
        invalid_properties.push('invalid value for "extended", extended cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reported_units == o.reported_units &&
          received_units == o.received_units &&
          status == o.status &&
    ...
    def hash
      [id, type, logistics_sku, barcode, shipment_id, shipping_plan_id, reported_units, received_units, status, created_at, updated_at, dispute, extended].hash
    end
