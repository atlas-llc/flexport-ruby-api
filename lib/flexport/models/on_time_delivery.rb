...
module Flexport
  class OnTimeDelivery
    attr_accessor :on_time_delivery_data

    attr_accessor :late_shipping_data

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'on_time_delivery_data' => :'onTimeDeliveryData',
        :'late_shipping_data' => :'lateShippingData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OnTimeDelivery` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OnTimeDelivery`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'on_time_delivery_data')
        self.on_time_delivery_data = attributes[:'on_time_delivery_data']
      else
        self.on_time_delivery_data = nil
      end

      if attributes.key?(:'late_shipping_data')
        self.late_shipping_data = attributes[:'late_shipping_data']
      else
        self.late_shipping_data = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @on_time_delivery_data.nil?
        invalid_properties.push('invalid value for "on_time_delivery_data", on_time_delivery_data cannot be nil.')
      end

      if @late_shipping_data.nil?
        invalid_properties.push('invalid value for "late_shipping_data", late_shipping_data cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @on_time_delivery_data.nil?
      return false if @late_shipping_data.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          on_time_delivery_data == o.on_time_delivery_data &&
          late_shipping_data == o.late_shipping_data
    end
    ...
    def hash
      [on_time_delivery_data, late_shipping_data].hash
    end
