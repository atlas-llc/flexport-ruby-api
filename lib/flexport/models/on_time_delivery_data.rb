...
module Flexport
  class OnTimeDeliveryData
    attr_accessor :on_time

    attr_accessor :one_day_delivery

    attr_accessor :two_days_delivery

    attr_accessor :three_days_delivery

    attr_accessor :four_plus_days_delivery

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'on_time' => :'onTime',
        :'one_day_delivery' => :'oneDayDelivery',
        :'two_days_delivery' => :'twoDaysDelivery',
        :'three_days_delivery' => :'threeDaysDelivery',
        :'four_plus_days_delivery' => :'fourPlusDaysDelivery'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OnTimeDeliveryData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OnTimeDeliveryData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'on_time')
        self.on_time = attributes[:'on_time']
      else
        self.on_time = nil
      end

      if attributes.key?(:'one_day_delivery')
        self.one_day_delivery = attributes[:'one_day_delivery']
      else
        self.one_day_delivery = nil
      end

      if attributes.key?(:'two_days_delivery')
        self.two_days_delivery = attributes[:'two_days_delivery']
      else
        self.two_days_delivery = nil
      end

      if attributes.key?(:'three_days_delivery')
        self.three_days_delivery = attributes[:'three_days_delivery']
      else
        self.three_days_delivery = nil
      end

      if attributes.key?(:'four_plus_days_delivery')
        self.four_plus_days_delivery = attributes[:'four_plus_days_delivery']
      else
        self.four_plus_days_delivery = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @on_time.nil?
        invalid_properties.push('invalid value for "on_time", on_time cannot be nil.')
      end

      if @one_day_delivery.nil?
        invalid_properties.push('invalid value for "one_day_delivery", one_day_delivery cannot be nil.')
      end

      if @two_days_delivery.nil?
        invalid_properties.push('invalid value for "two_days_delivery", two_days_delivery cannot be nil.')
      end

      if @three_days_delivery.nil?
        invalid_properties.push('invalid value for "three_days_delivery", three_days_delivery cannot be nil.')
      end

      if @four_plus_days_delivery.nil?
        invalid_properties.push('invalid value for "four_plus_days_delivery", four_plus_days_delivery cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @on_time.nil?
      return false if @one_day_delivery.nil?
      return false if @two_days_delivery.nil?
      return false if @three_days_delivery.nil?
      return false if @four_plus_days_delivery.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          on_time == o.on_time &&
          one_day_delivery == o.one_day_delivery &&
          two_days_delivery == o.two_days_delivery &&
          three_days_delivery == o.three_days_delivery &&
          four_plus_days_delivery == o.four_plus_days_delivery
    end
    ...
    def hash
      [on_time, one_day_delivery, two_days_delivery, three_days_delivery, four_plus_days_delivery].hash
    end
