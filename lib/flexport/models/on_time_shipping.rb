...
module Flexport
  class OnTimeShipping
    attr_accessor :on_time_shipping

    attr_accessor :delayed_shipping_data

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'on_time_shipping' => :'onTimeShipping',
        :'delayed_shipping_data' => :'delayedShippingData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OnTimeShipping` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OnTimeShipping`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'delayed_shipping_data')
        self.delayed_shipping_data = attributes[:'delayed_shipping_data']
      else
        self.delayed_shipping_data = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @delayed_shipping_data.nil?
        invalid_properties.push('invalid value for "delayed_shipping_data", delayed_shipping_data cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @delayed_shipping_data.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delayed_shipping_data == o.delayed_shipping_data
    end
    ...
    def hash
      [on_time_shipping, delayed_shipping_data].hash
    end
