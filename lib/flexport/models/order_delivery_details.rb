...
module Flexport
  class OrderDeliveryDetails
    ...
    attr_accessor :lift_gate_required

    attr_accessor :location_type

    attr_accessor :appointment_required

    attr_accessor :dropoff_reference_number

    attr_accessor :trading_partner_details
    ...
    def self.attribute_map
      {
        ...
        :'contact' => :'contact',
        :'notes' => :'notes',
        :'lift_gate_required' => :'liftGateRequired',
        :'location_type' => :'locationType',
        :'appointment_required' => :'appointmentRequired',
        :'dropoff_reference_number' => :'dropoffReferenceNumber',
        :'trading_partner_details' => :'tradingPartnerDetails'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'dropoff_reference_number' => :'String',
        :'trading_partner_details' => :'TradingPartnerDetails'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OrderDeliveryDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OrderDeliveryDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lift_gate_required')
        self.lift_gate_required = attributes[:'lift_gate_required']
      end
      ...
      if attributes.key?(:'appointment_required')
        self.appointment_required = attributes[:'appointment_required']
      end

      if attributes.key?(:'dropoff_reference_number')
        self.dropoff_reference_number = attributes[:'dropoff_reference_number']
      end

      if attributes.key?(:'trading_partner_details')
        self.trading_partner_details = attributes[:'trading_partner_details']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          contact == o.contact &&
          notes == o.notes &&
          lift_gate_required == o.lift_gate_required &&
          location_type == o.location_type &&
          appointment_required == o.appointment_required &&
          dropoff_reference_number == o.dropoff_reference_number &&
          trading_partner_details == o.trading_partner_details
    end
    ...
    def hash
      [address, contact, notes, lift_gate_required, location_type, appointment_required, dropoff_reference_number, trading_partner_details].hash
    end
