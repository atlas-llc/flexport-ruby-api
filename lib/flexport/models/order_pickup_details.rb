...
module Flexport
  class OrderPickupDetails
    attr_accessor :cargo_ready_date
    ...
    attr_accessor :pickup_reference_number
    ...
    def self.attribute_map
      {
        ...
        :'pickup_reference_number' => :'pickupReferenceNumber'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OrderPickupDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OrderPickupDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'cargo_ready_date')
        self.cargo_ready_date = attributes[:'cargo_ready_date']
      else
        self.cargo_ready_date = nil
      end
      ...
      if attributes.key?(:'pickup_reference_number')
        self.pickup_reference_number = attributes[:'pickup_reference_number']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cargo_ready_date.nil?
        invalid_properties.push('invalid value for "cargo_ready_date", cargo_ready_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cargo_ready_date.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cargo_ready_date == o.cargo_ready_date &&
          address == o.address &&
          contact == o.contact &&
          notes == o.notes &&
          lift_gate_required == o.lift_gate_required &&
          location_type == o.location_type &&
          pickup_reference_number == o.pickup_reference_number
    end
    ...
    def hash
      [cargo_ready_date, address, contact, notes, lift_gate_required, location_type, pickup_reference_number].hash
    end
