...
module Flexport
  class OrderState
    attr_accessor :fulfillment_delayed

    attr_accessor :fulfillment_in_progress
    ...
    def self.openapi_types
      {
        ...
        :'fulfillment_status' => :'ExternalOrderStatus',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OrderState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OrderState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'fulfillment_delayed')
        self.fulfillment_delayed = attributes[:'fulfillment_delayed']
      else
        self.fulfillment_delayed = nil
      end

      if attributes.key?(:'fulfillment_in_progress')
        self.fulfillment_in_progress = attributes[:'fulfillment_in_progress']
      else
        self.fulfillment_in_progress = nil
      end
    ...
    def list_invalid_properties
      ...
      if @fulfillment_delayed.nil?
        invalid_properties.push('invalid value for "fulfillment_delayed", fulfillment_delayed cannot be nil.')
      end

      if @fulfillment_in_progress.nil?
        invalid_properties.push('invalid value for "fulfillment_in_progress", fulfillment_in_progress cannot be nil.')
      end
      ...
      if @internal_status.nil?
        invalid_properties.push('invalid value for "internal_status", internal_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fulfillment_delayed.nil?
      return false if @fulfillment_in_progress.nil?
      return false if @fulfillment_status.nil?
      return false if @internal_status.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fulfillment_delayed == o.fulfillment_delayed &&
          fulfillment_in_progress == o.fulfillment_in_progress &&
    ...
    def hash
      [fulfillment_delayed, fulfillment_in_progress, fulfillment_status, internal_status].hash
    end
