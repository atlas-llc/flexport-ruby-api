...
module Flexport
  class OrdersByDate
    ...
    attr_accessor :one_to_three_day_orders

    attr_accessor :four_plus_day_orders
    ...
    def self.attribute_map
      {
        ...
        :'one_to_three_day_orders' => :'oneToThreeDayOrders',
        :'four_plus_day_orders' => :'fourPlusDayOrders'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OrdersByDate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OrdersByDate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'one_to_three_day_orders')
        self.one_to_three_day_orders = attributes[:'one_to_three_day_orders']
      else
        self.one_to_three_day_orders = nil
      end

      if attributes.key?(:'four_plus_day_orders')
        self.four_plus_day_orders = attributes[:'four_plus_day_orders']
      else
        self.four_plus_day_orders = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @one_to_three_day_orders.nil?
        invalid_properties.push('invalid value for "one_to_three_day_orders", one_to_three_day_orders cannot be nil.')
      end

      if @four_plus_day_orders.nil?
        invalid_properties.push('invalid value for "four_plus_day_orders", four_plus_day_orders cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @one_to_three_day_orders.nil?
      return false if @four_plus_day_orders.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          one_to_three_day_orders == o.one_to_three_day_orders &&
          four_plus_day_orders == o.four_plus_day_orders
    end
    ...
    def hash
      [date, order_count, one_to_three_day_orders, four_plus_day_orders].hash
    end
