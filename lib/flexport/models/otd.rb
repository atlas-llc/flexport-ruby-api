...
module Flexport
  class OTD
    ...
    attr_accessor :one_day_late

    attr_accessor :two_days_late

    attr_accessor :three_plus_days_late

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'on_time' => :'onTime',
        :'one_day_late' => :'oneDayLate',
        :'two_days_late' => :'twoDaysLate',
        :'three_plus_days_late' => :'threePlusDaysLate'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OTD` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OTD`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'one_day_late')
        self.one_day_late = attributes[:'one_day_late']
      else
        self.one_day_late = nil
      end

      if attributes.key?(:'two_days_late')
        self.two_days_late = attributes[:'two_days_late']
      else
        self.two_days_late = nil
      end

      if attributes.key?(:'three_plus_days_late')
        self.three_plus_days_late = attributes[:'three_plus_days_late']
      else
        self.three_plus_days_late = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @one_day_late.nil?
        invalid_properties.push('invalid value for "one_day_late", one_day_late cannot be nil.')
      end

      if @two_days_late.nil?
        invalid_properties.push('invalid value for "two_days_late", two_days_late cannot be nil.')
      end

      if @three_plus_days_late.nil?
        invalid_properties.push('invalid value for "three_plus_days_late", three_plus_days_late cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @one_day_late.nil?
      return false if @two_days_late.nil?
      return false if @three_plus_days_late.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          on_time == o.on_time &&
          one_day_late == o.one_day_late &&
          two_days_late == o.two_days_late &&
          three_plus_days_late == o.three_plus_days_late
    end
    ...
    def hash
      [on_time, one_day_late, two_days_late, three_plus_days_late].hash
    end
