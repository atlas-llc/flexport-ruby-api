...
module Flexport
  class OTS
    ...
    attr_accessor :warehouse_stockout

    attr_accessor :late_status_update

    attr_accessor :warehouse_delay
    ...
    def self.attribute_map
      {
        :'on_time' => :'onTime',
        :'warehouse_stockout' => :'warehouseStockout',
        :'late_status_update' => :'lateStatusUpdate',
        :'warehouse_delay' => :'warehouseDelay',
        :'other' => :'other'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::OTS` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::OTS`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'warehouse_stockout')
        self.warehouse_stockout = attributes[:'warehouse_stockout']
      else
        self.warehouse_stockout = nil
      end

      if attributes.key?(:'late_status_update')
        self.late_status_update = attributes[:'late_status_update']
      else
        self.late_status_update = nil
      end

      if attributes.key?(:'warehouse_delay')
        self.warehouse_delay = attributes[:'warehouse_delay']
      else
        self.warehouse_delay = nil
      end
    ...
    def list_invalid_properties
      ...
      if @warehouse_stockout.nil?
        invalid_properties.push('invalid value for "warehouse_stockout", warehouse_stockout cannot be nil.')
      end

      if @late_status_update.nil?
        invalid_properties.push('invalid value for "late_status_update", late_status_update cannot be nil.')
      end

      if @warehouse_delay.nil?
        invalid_properties.push('invalid value for "warehouse_delay", warehouse_delay cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @warehouse_stockout.nil?
      return false if @late_status_update.nil?
      return false if @warehouse_delay.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          on_time == o.on_time &&
          warehouse_stockout == o.warehouse_stockout &&
          late_status_update == o.late_status_update &&
          warehouse_delay == o.warehouse_delay &&
          other == o.other
    end
    ...
    def hash
      [on_time, warehouse_stockout, late_status_update, warehouse_delay, other].hash
    end
