...
module Flexport
  class PackageDetails
    ...
    attr_accessor :nmfc_code

    attr_accessor :sub_nmfc_code
    ...
    def self.openapi_types
      {
        ...
        :'nmfc_code' => :'String',
        :'sub_nmfc_code' => :'String',
        :'dimension_unit' => :'PackageDetailsDimensionUnitEnum',
        :'weight_unit' => :'PackageDetailsWeightUnitEnum'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PackageDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PackageDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'nmfc_code')
        self.nmfc_code = attributes[:'nmfc_code']
      end

      if attributes.key?(:'sub_nmfc_code')
        self.sub_nmfc_code = attributes[:'sub_nmfc_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nmfc_code == o.nmfc_code &&
          sub_nmfc_code == o.sub_nmfc_code &&
    ...
    def hash
      [pallet_count, length, width, height, weight, stackable, freight_class, nmfc_code, sub_nmfc_code, dimension_unit, weight_unit].hash
    end
