...
module Flexport
  # Package configuration for inbound shipment requests.
  class PackageInputUnstable
    ...
    attr_accessor :number_of_identical_pkgs
    ...
    def self.attribute_map
      {
        ...
        :'items' => :'items',
        :'number_of_identical_pkgs' => :'numberOfIdenticalPkgs'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PackageInputUnstable` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PackageInputUnstable`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_identical_pkgs')
        self.number_of_identical_pkgs = attributes[:'number_of_identical_pkgs']
      else
        self.number_of_identical_pkgs = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @number_of_identical_pkgs.nil?
        invalid_properties.push('invalid value for "number_of_identical_pkgs", number_of_identical_pkgs cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @number_of_identical_pkgs.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          items == o.items &&
          number_of_identical_pkgs == o.number_of_identical_pkgs
    end
    ...
    def hash
      [length, width, height, weight, dimension_unit, weight_unit, items, number_of_identical_pkgs].hash
    end
