...
module Flexport
  # Package configuration for inbound shipment response.
  class PackageOutputUnstable
    ...
    attr_accessor :identical_package_config_identifer
    ...
    def self.attribute_map
      {
        ...
        :'id' => :'id',
        :'identical_package_config_identifer' => :'identicalPackageConfigIdentifer',
        :'items' => :'items'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'weight_unit' => :'WeightUnit',
        :'id' => :'String',
        :'identical_package_config_identifer' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PackageOutputUnstable` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PackageOutputUnstable`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'identical_package_config_identifer')
        self.identical_package_config_identifer = attributes[:'identical_package_config_identifer']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          identical_package_config_identifer == o.identical_package_config_identifer &&
          items == o.items
    end
    ...
    def hash
      [length, width, height, weight, dimension_unit, weight_unit, id, identical_package_config_identifer, items].hash
    end
