...
module Flexport
  # Pallet configuration used for internal freight inbound shipments.
  class PalletInput
    ...
    attr_accessor :number_of_identical_pallets
    ...
    def self.attribute_map
      {
        ...
        :'number_of_identical_pallets' => :'numberOfIdenticalPallets'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PalletInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PalletInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_identical_pallets')
        self.number_of_identical_pallets = attributes[:'number_of_identical_pallets']
      else
        self.number_of_identical_pallets = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @number_of_identical_pallets.nil?
        invalid_properties.push('invalid value for "number_of_identical_pallets", number_of_identical_pallets cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @number_of_identical_pallets.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number_of_identical_pallets == o.number_of_identical_pallets
    end
    ...
    def hash
      [length, width, height, dimension_unit, weight, weight_unit, number_of_identical_pallets].hash
    end
