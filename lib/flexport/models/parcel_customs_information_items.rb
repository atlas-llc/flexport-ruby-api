...
module Flexport
  class ParcelCustomsInformationItems
    attr_accessor :code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ParcelCustomsInformationItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ParcelCustomsInformationItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hs_tariff_code')
        self.hs_tariff_code = attributes[:'hs_tariff_code']
      else
        self.hs_tariff_code = nil
      end
    ...
    def list_invalid_properties
      ...
      if @hs_tariff_code.nil?
        invalid_properties.push('invalid value for "hs_tariff_code", hs_tariff_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @hs_tariff_code.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          value == o.value &&
          hs_tariff_code == o.hs_tariff_code &&
    ...
    def hash
      [code, description, quantity, weight, weight_unit, value, hs_tariff_code, origin_country].hash
    end
