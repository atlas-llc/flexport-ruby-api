...
module Flexport
  class PartnerApplication
    ...
    attr_accessor :is_test_application
    ...
    def self.attribute_map
      {
        ...
        :'is_test_application' => :'isTestApplication',
        :'status' => :'status',
        :'type' => :'type',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PartnerApplication` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PartnerApplication`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_test_application')
        self.is_test_application = attributes[:'is_test_application']
      else
        self.is_test_application = nil
      end
      ...
      if attributes.key?(:'install_uri')
        self.install_uri = attributes[:'install_uri']
      else
        self.install_uri = nil
      end
    ...
    def list_invalid_properties
      ...
      if @is_test_application.nil?
        invalid_properties.push('invalid value for "is_test_application", is_test_application cannot be nil.')
      end
      ...
      if @install_uri.nil?
        invalid_properties.push('invalid value for "install_uri", install_uri cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_test_application.nil?
      return false if @status.nil?
      return false if @type.nil?
      return false if @public_status.nil?
      public_status_validator = EnumAttributeValidator.new('String', ["SUBMITTED", "APPROVED", "REJECTED"])
      return false unless public_status_validator.valid?(@public_status)
      return false if @install_uri.nil?
    ...
    # @param [Object] public_status Object to be assigned
    def public_status=(public_status)
      validator = EnumAttributeValidator.new('String', ["SUBMITTED", "APPROVED", "REJECTED"])
      unless validator.valid?(public_status)
        fail ArgumentError, "invalid value for \"public_status\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_test_application == o.is_test_application &&
          status == o.status &&
          type == o.type &&
          created_at == o.created_at &&
          updated_at == o.updated_at &&
          public_status == o.public_status &&
          install_uri == o.install_uri &&
    ...
    def hash
      [id, partner_id, is_test_application, status, type, created_at, updated_at, public_status, install_uri, redirect_uri, client_secret, logistics_account_id, seller_id, partner_name].hash
    end
