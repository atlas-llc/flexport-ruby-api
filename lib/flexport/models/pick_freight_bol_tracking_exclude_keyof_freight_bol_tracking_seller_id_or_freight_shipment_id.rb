...
module Flexport
  ...
  class PickFreightBolTrackingExcludeKeyofFreightBolTrackingSellerIdOrFreightShipmentId
    attr_accessor :pickup_details

    attr_accessor :delivery_details

    attr_accessor :bol_id

    attr_accessor :mode

    attr_accessor :bol_status

    attr_accessor :carrier_name

    attr_accessor :estimated_pickup_time

    attr_accessor :estimated_delivery_time

    attr_accessor :estimated_port_departure_time

    attr_accessor :estimated_port_arrival_time

    attr_accessor :total_pallets
    ...
    def self.attribute_map
      {
        ...
        :'bol_id' => :'bolId',
        :'mode' => :'mode',
        :'bol_status' => :'bolStatus',
        :'carrier_name' => :'carrierName',
        :'estimated_pickup_time' => :'estimatedPickupTime',
        :'estimated_delivery_time' => :'estimatedDeliveryTime',
        :'estimated_port_departure_time' => :'estimatedPortDepartureTime',
        :'estimated_port_arrival_time' => :'estimatedPortArrivalTime',
    ...
    def self.openapi_types
      {
        :'pickup_details' => :'FreightStopDetails',
        :'delivery_details' => :'FreightStopDetails',
        :'bol_id' => :'String',
        :'mode' => :'FreightShipmentMode',
        :'bol_status' => :'FreightBolStatus',
        :'carrier_name' => :'String',
        :'estimated_pickup_time' => :'Time',
        :'estimated_delivery_time' => :'Time',
        :'estimated_port_departure_time' => :'Time',
        :'estimated_port_arrival_time' => :'Time',
        :'total_pallets' => :'Float',
        :'events' => :'Array<FreightTrackingEvent>',
        :'updated_at' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PickFreightBolTrackingExcludeKeyofFreightBolTrackingSellerIdOrFreightShipmentId` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PickFreightBolTrackingExcludeKeyofFreightBolTrackingSellerIdOrFreightShipmentId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bol_id')
        self.bol_id = attributes[:'bol_id']
      else
        self.bol_id = nil
      end
      ...
      if attributes.key?(:'bol_status')
        self.bol_status = attributes[:'bol_status']
      else
        self.bol_status = nil
      end
      ...
      if attributes.key?(:'estimated_pickup_time')
        self.estimated_pickup_time = attributes[:'estimated_pickup_time']
      end
      ...
      if attributes.key?(:'estimated_port_departure_time')
        self.estimated_port_departure_time = attributes[:'estimated_port_departure_time']
      end

      if attributes.key?(:'estimated_port_arrival_time')
        self.estimated_port_arrival_time = attributes[:'estimated_port_arrival_time']
      end

      if attributes.key?(:'total_pallets')
        self.total_pallets = attributes[:'total_pallets']
      end
    ...
    def list_invalid_properties
      ...
      if @pickup_details.nil?
        invalid_properties.push('invalid value for "pickup_details", pickup_details cannot be nil.')
      end
      ...
      if @bol_id.nil?
        invalid_properties.push('invalid value for "bol_id", bol_id cannot be nil.')
      end
      ...
      if @bol_status.nil?
        invalid_properties.push('invalid value for "bol_status", bol_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pickup_details.nil?
      return false if @delivery_details.nil?
      return false if @bol_id.nil?
      return false if @mode.nil?
      return false if @bol_status.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bol_id == o.bol_id &&
          mode == o.mode &&
          bol_status == o.bol_status &&
          carrier_name == o.carrier_name &&
          estimated_pickup_time == o.estimated_pickup_time &&
          estimated_delivery_time == o.estimated_delivery_time &&
          estimated_port_departure_time == o.estimated_port_departure_time &&
          estimated_port_arrival_time == o.estimated_port_arrival_time &&
    ...
    def hash
      [pickup_details, delivery_details, bol_id, mode, bol_status, carrier_name, estimated_pickup_time, estimated_delivery_time, estimated_port_departure_time, estimated_port_arrival_time, total_pallets, events, updated_at].hash
    end
