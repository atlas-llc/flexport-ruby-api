...
module Flexport
  ...
  class PickFulfillmentShipmentExcludeKeyofFulfillmentShipmentWarehouse
    ...
    attr_accessor :estimated_ship_time

    attr_accessor :label_print_time

    # The id of the location (warehouse) that the shipment was processed at.
    attr_accessor :warehouse_id

    attr_accessor :warehouse_order_id
    ...
    def self.attribute_map
      {
        ...
        :'estimated_ship_time' => :'estimatedShipTime',
    ...
    def self.openapi_types
      {
        ...
        :'line_items' => :'Array<FulfillmentShipmentItem>',
        :'shipped_at' => :'Time',
        :'estimated_ship_time' => :'Time',
        :'label_print_time' => :'Time',
        :'warehouse_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PickFulfillmentShipmentExcludeKeyofFulfillmentShipmentWarehouse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PickFulfillmentShipmentExcludeKeyofFulfillmentShipmentWarehouse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'estimated_ship_time')
        self.estimated_ship_time = attributes[:'estimated_ship_time']
      end

      if attributes.key?(:'label_print_time')
        self.label_print_time = attributes[:'label_print_time']
      end
      ...
      if attributes.key?(:'warehouse_order_id')
        self.warehouse_order_id = attributes[:'warehouse_order_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          estimated_ship_time == o.estimated_ship_time &&
          label_print_time == o.label_print_time &&
          warehouse_id == o.warehouse_id &&
          warehouse_order_id == o.warehouse_order_id
    end
    ...
    def hash
      [packages, id, created_at, status, estimated_delivery_time, line_items, shipped_at, estimated_ship_time, label_print_time, warehouse_id, warehouse_order_id].hash
    end
