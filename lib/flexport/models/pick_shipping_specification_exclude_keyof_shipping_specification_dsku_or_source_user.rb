...
module Flexport
  ...
  class PickShippingSpecificationExcludeKeyofShippingSpecificationDskuOrSourceUser
    attr_accessor :source

    attr_accessor :minimum_packaging_type
    ...
    def self.attribute_map
      {
        :'source' => :'source',
        :'minimum_packaging_type' => :'minimumPackagingType'
      }
    end
    ...
    def self.openapi_types
      {
        :'source' => :'ShippingSpecificationSourceType',
        :'minimum_packaging_type' => :'PackagingType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PickShippingSpecificationExcludeKeyofShippingSpecificationDskuOrSourceUser` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PickShippingSpecificationExcludeKeyofShippingSpecificationDskuOrSourceUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'minimum_packaging_type')
        self.minimum_packaging_type = attributes[:'minimum_packaging_type']
      else
        self.minimum_packaging_type = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @minimum_packaging_type.nil?
        invalid_properties.push('invalid value for "minimum_packaging_type", minimum_packaging_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @minimum_packaging_type.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          source == o.source &&
          minimum_packaging_type == o.minimum_packaging_type
    end
    ...
    def hash
      [source, minimum_packaging_type].hash
    end
