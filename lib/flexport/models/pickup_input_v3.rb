...
module Flexport
  class PickupInputV3
    attr_accessor :ready_date

    attr_accessor :facility_hours_start

    attr_accessor :facility_hours_end
    ...
    def self.attribute_map
      {
        ...
        :'facility_hours_start' => :'facilityHoursStart',
        :'facility_hours_end' => :'facilityHoursEnd',
    ...
    def self.openapi_types
      {
        :'ready_date' => :'Time',
        :'facility_hours_start' => :'String',
        :'facility_hours_end' => :'String',
        :'contact_name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PickupInputV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PickupInputV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'ready_date')
        self.ready_date = attributes[:'ready_date']
      else
        self.ready_date = nil
      end

      if attributes.key?(:'facility_hours_start')
        self.facility_hours_start = attributes[:'facility_hours_start']
      end

      if attributes.key?(:'facility_hours_end')
        self.facility_hours_end = attributes[:'facility_hours_end']
      end
    ...
    def list_invalid_properties
      ...
      if @ready_date.nil?
        invalid_properties.push('invalid value for "ready_date", ready_date cannot be nil.')
      end
      ...
      if @lift_gate.nil?
        invalid_properties.push('invalid value for "lift_gate", lift_gate cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          facility_hours_start == o.facility_hours_start &&
          facility_hours_end == o.facility_hours_end &&
    ...
    def hash
      [ready_date, facility_hours_start, facility_hours_end, contact_name, contact_phone, contact_email, lift_gate, customer_reference_number].hash
    end
