...
module Flexport
  class PrepRequestData
    attr_accessor :box_content_labels

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'box_content_labels' => :'boxContentLabels'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PrepRequestData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PrepRequestData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'box_content_labels')
        self.box_content_labels = attributes[:'box_content_labels']
      else
        self.box_content_labels = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @box_content_labels.nil?
        invalid_properties.push('invalid value for "box_content_labels", box_content_labels cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @box_content_labels.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          box_content_labels == o.box_content_labels
    end
