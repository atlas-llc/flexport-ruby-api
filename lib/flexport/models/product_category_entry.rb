  ...
  class ProductCategoryEntry
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ProductCategoryEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ProductCategoryEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ancestor_names')
        self.ancestor_names = attributes[:'ancestor_names']
      else
        self.ancestor_names = nil
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          category == o.category &&
          ancestor_names == o.ancestor_names
    end
    ...
    def hash
      [id, category, ancestor_names].hash
    end
