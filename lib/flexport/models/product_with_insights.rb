...
module Flexport
  class ProductWithInsights
    ...
    attr_accessor :shipping_specification
    ...
    def self.attribute_map
      {
        ...
        :'inventory' => :'inventory',
        :'shipping_specification' => :'shippingSpecification',
        :'category' => :'category',
        :'insights' => :'insights'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'inventory' => :'Inventory',
        :'shipping_specification' => :'PickShippingSpecificationExcludeKeyofShippingSpecificationDskuOrSourceUser',
        :'category' => :'ProductCategoryEntry',
        :'insights' => :'ProductWithInsightsInsights'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ProductWithInsights` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ProductWithInsights`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipping_specification')
        self.shipping_specification = attributes[:'shipping_specification']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_specification == o.shipping_specification &&
          category == o.category &&
          insights == o.insights
    end
    ...
    def hash
      [name, merchant_sku, logistics_sku, barcodes, dimensions, inventory, shipping_specification, category, insights].hash
    end
