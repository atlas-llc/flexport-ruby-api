...
module Flexport
  class ProductWithInsightsInsights
    attr_accessor :insights_updated_at

    attr_accessor :unavailable_for_insights

    attr_accessor :available_for_insights

    attr_accessor :weeks_of_supply

    attr_accessor :avg_forecast

    attr_accessor :avg_historical

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'insights_updated_at' => :'insightsUpdatedAt',
        :'unavailable_for_insights' => :'unavailableForInsights',
        :'available_for_insights' => :'availableForInsights',
    ...
    def self.openapi_nullable
      Set.new([
        :'insights_updated_at',
        :'unavailable_for_insights',
        :'available_for_insights',
        :'weeks_of_supply',
        :'avg_forecast',
        :'avg_historical'
      ])
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ProductWithInsightsInsights` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ProductWithInsightsInsights`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'insights_updated_at')
        self.insights_updated_at = attributes[:'insights_updated_at']
      else
        self.insights_updated_at = nil
      end

      if attributes.key?(:'unavailable_for_insights')
        self.unavailable_for_insights = attributes[:'unavailable_for_insights']
      else
        self.unavailable_for_insights = nil
      end

      if attributes.key?(:'available_for_insights')
        self.available_for_insights = attributes[:'available_for_insights']
      else
        self.available_for_insights = nil
      end

      if attributes.key?(:'weeks_of_supply')
        self.weeks_of_supply = attributes[:'weeks_of_supply']
      else
        self.weeks_of_supply = nil
      end

      if attributes.key?(:'avg_forecast')
        self.avg_forecast = attributes[:'avg_forecast']
      else
        self.avg_forecast = nil
      end

      if attributes.key?(:'avg_historical')
        self.avg_historical = attributes[:'avg_historical']
      else
        self.avg_historical = nil
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          insights_updated_at == o.insights_updated_at &&
          unavailable_for_insights == o.unavailable_for_insights &&
          available_for_insights == o.available_for_insights &&
          weeks_of_supply == o.weeks_of_supply &&
          avg_forecast == o.avg_forecast &&
          avg_historical == o.avg_historical
    end
    ...
    def hash
      [insights_updated_at, unavailable_for_insights, available_for_insights, weeks_of_supply, avg_forecast, avg_historical].hash
    end
