...
module Flexport
  class PromisedDeliverySpeeds
    attr_accessor :one_day

    attr_accessor :two_day

    attr_accessor :three_day

    attr_accessor :four_day_plus
    ...
    def self.openapi_types
      {
        :'one_day' => :'PromisedDeliverySpeedsDelta',
        :'two_day' => :'PromisedDeliverySpeedsDelta',
        :'three_day' => :'PromisedDeliverySpeedsDelta',
        :'four_day_plus' => :'PromisedDeliverySpeedsDelta',
        :'timezone' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PromisedDeliverySpeeds` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PromisedDeliverySpeeds`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'one_day')
        self.one_day = attributes[:'one_day']
      else
        self.one_day = nil
      end

      if attributes.key?(:'two_day')
        self.two_day = attributes[:'two_day']
      else
        self.two_day = nil
      end

      if attributes.key?(:'three_day')
        self.three_day = attributes[:'three_day']
      else
        self.three_day = nil
      end

      if attributes.key?(:'four_day_plus')
        self.four_day_plus = attributes[:'four_day_plus']
      else
        self.four_day_plus = nil
      end
    ...
    def list_invalid_properties
      ...
      if @one_day.nil?
        invalid_properties.push('invalid value for "one_day", one_day cannot be nil.')
      end

      if @two_day.nil?
        invalid_properties.push('invalid value for "two_day", two_day cannot be nil.')
      end

      if @three_day.nil?
        invalid_properties.push('invalid value for "three_day", three_day cannot be nil.')
      end

      if @four_day_plus.nil?
        invalid_properties.push('invalid value for "four_day_plus", four_day_plus cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @one_day.nil?
      return false if @two_day.nil?
      return false if @three_day.nil?
      return false if @four_day_plus.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          one_day == o.one_day &&
          two_day == o.two_day &&
          three_day == o.three_day &&
          four_day_plus == o.four_day_plus &&
          timezone == o.timezone
    end
    ...
    def hash
      [one_day, two_day, three_day, four_day_plus, timezone].hash
    end
