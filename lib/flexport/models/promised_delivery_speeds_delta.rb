...
module Flexport
  class PromisedDeliverySpeedsDelta
    attr_accessor :percentage

    attr_accessor :delta_over_previous_period

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'percentage' => :'percentage',
        :'delta_over_previous_period' => :'deltaOverPreviousPeriod'
      }
    end
    ...
    def self.openapi_types
      {
        :'percentage' => :'Float',
        :'delta_over_previous_period' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::PromisedDeliverySpeedsDelta` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::PromisedDeliverySpeedsDelta`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'delta_over_previous_period')
        self.delta_over_previous_period = attributes[:'delta_over_previous_period']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delta_over_previous_period == o.delta_over_previous_period
    end
    ...
    def hash
      [percentage, delta_over_previous_period].hash
    end
