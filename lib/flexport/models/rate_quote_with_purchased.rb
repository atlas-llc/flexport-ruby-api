  ...
  class RateQuoteWithPurchased
    ...
    def self.openapi_types
      {
        ...
        :'shipping_option' => :'InboundShippingOption'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::RateQuoteWithPurchased` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::RateQuoteWithPurchased`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'estimated_time_of_arrival')
        self.estimated_time_of_arrival = attributes[:'estimated_time_of_arrival']
      else
        self.estimated_time_of_arrival = nil
      end
    ...
    def list_invalid_properties
      ...
      if @estimated_time_of_arrival.nil?
        invalid_properties.push('invalid value for "estimated_time_of_arrival", estimated_time_of_arrival cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @estimated_time_of_arrival.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          estimated_time_of_arrival == o.estimated_time_of_arrival &&
    ...
    def hash
      [id, rate_shopping_method, amount, full_amount, currency, shipping_provider, provider_method, purchased, estimated_time_of_arrival, shipping_option].hash
    end
