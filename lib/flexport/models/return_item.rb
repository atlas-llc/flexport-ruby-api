  ...
  class ReturnItem
    ...
    def self.openapi_types
      {
        ...
        :'inspected_items' => :'Array<InspectedItem>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ReturnItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ReturnItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expected_quantity')
        ...
        self.expected_quantity = nil
      end

      if attributes.key?(:'inspected_items')
        if (value = attributes[:'inspected_items']).is_a?(Array)
          self.inspected_items = value
        end
      else
        self.inspected_items = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @inspected_items.nil?
        invalid_properties.push('invalid value for "inspected_items", inspected_items cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @inspected_items.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inspected_items == o.inspected_items
    end
    ...
    def hash
      [identifier, expected_quantity, inspected_items].hash
    end
