...
module Flexport
  class ReturnProductInspectionDetail
    # Quantity of the inspected item.
    attr_accessor :quantity

    # Initial condition of the inspected item.
    attr_accessor :initial_condition

    # Final condition of the inspected item.
    attr_accessor :final_condition

    # Final disposition/outcome of the inspected item.
    attr_accessor :disposition

    # SopId of the inspected item denotes which SOP was executed.
    attr_accessor :sop_id

    # Lot number of the inspected item.
    attr_accessor :lot_number

    # Value-Added services applied on the inspected item.
    attr_accessor :vas_applied

    # Return tag of the inspected item i.e license-plate or item-tag.
    attr_accessor :item_tag

    # Image urls of the inspected item.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ReturnProductInspectionDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ReturnProductInspectionDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'initial_condition')
        self.initial_condition = attributes[:'initial_condition']
      end

      if attributes.key?(:'final_condition')
        self.final_condition = attributes[:'final_condition']
      end
      ...
      if attributes.key?(:'sop_id')
        self.sop_id = attributes[:'sop_id']
      end
      ...
      if attributes.key?(:'vas_applied')
        self.vas_applied = attributes[:'vas_applied']
      end

      if attributes.key?(:'item_tag')
        self.item_tag = attributes[:'item_tag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          quantity == o.quantity &&
          initial_condition == o.initial_condition &&
          final_condition == o.final_condition &&
          disposition == o.disposition &&
          sop_id == o.sop_id &&
          lot_number == o.lot_number &&
          vas_applied == o.vas_applied &&
          item_tag == o.item_tag &&
          images == o.images
    end
    ...
    def hash
      [quantity, initial_condition, final_condition, disposition, sop_id, lot_number, vas_applied, item_tag, images].hash
    end
