...
module Flexport
  class ReturnReceivedEvent
    ...
    # Logistics event ID
    attr_accessor :logistics_event_id

    # Event type
    attr_accessor :logistics_event_type

    # Time when the event occurred
    attr_accessor :logistics_event_time
    ...
    def self.attribute_map
      {
        ...
        :'logistics_event_type' => :'logisticsEventType',
        :'logistics_event_time' => :'logisticsEventTime',
        :'type' => :'type',
        :'amount' => :'amount',
    ...
    def self.openapi_types
      {
        :'logistics_account_id' => :'Object',
        :'logistics_event_id' => :'Object',
        :'logistics_event_type' => :'Object',
        :'logistics_event_time' => :'Object',
        :'type' => :'String',
        :'amount' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ReturnReceivedEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ReturnReceivedEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'logistics_event_id')
        self.logistics_event_id = attributes[:'logistics_event_id']
      else
        self.logistics_event_id = nil
      end

      if attributes.key?(:'logistics_event_type')
        self.logistics_event_type = attributes[:'logistics_event_type']
      else
        self.logistics_event_type = nil
      end

      if attributes.key?(:'logistics_event_time')
        self.logistics_event_time = attributes[:'logistics_event_time']
      else
        self.logistics_event_time = nil
      end
    ...
    def list_invalid_properties
      ...
      if @logistics_sku.to_s.length > 11
        invalid_properties.push('invalid value for "logistics_sku", the character length must be smaller than or equal to 11.')
      end

      if @logistics_sku.to_s.length < 11
        invalid_properties.push('invalid value for "logistics_sku", the character length must be great than or equal to 11.')
      end

      pattern = Regexp.new(/^D[0-9a-zA-Z]+$/)
      if @logistics_sku !~ pattern
        invalid_properties.push("invalid value for \"logistics_sku\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if @logistics_sku.to_s.length > 11
      return false if @logistics_sku.to_s.length < 11
      return false if @logistics_sku !~ Regexp.new(/^D[0-9a-zA-Z]+$/)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] logistics_sku Value to be assigned
    def logistics_sku=(logistics_sku)
      if logistics_sku.nil?
        fail ArgumentError, 'logistics_sku cannot be nil'
      end

      if logistics_sku.to_s.length > 11
        fail ArgumentError, 'invalid value for "logistics_sku", the character length must be smaller than or equal to 11.'
      end

      if logistics_sku.to_s.length < 11
        fail ArgumentError, 'invalid value for "logistics_sku", the character length must be great than or equal to 11.'
      end

      pattern = Regexp.new(/^D[0-9a-zA-Z]+$/)
      if logistics_sku !~ pattern
        fail ArgumentError, "invalid value for \"logistics_sku\", must conform to the pattern #{pattern}."
      end

      @logistics_sku = logistics_sku
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          logistics_event_id == o.logistics_event_id &&
          logistics_event_type == o.logistics_event_type &&
          logistics_event_time == o.logistics_event_time &&
          type == o.type &&
          amount == o.amount &&
    ...
    def hash
      [logistics_account_id, logistics_event_id, logistics_event_type, logistics_event_time, type, amount, logistics_sku].hash
    end
