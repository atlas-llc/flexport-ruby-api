...
module Flexport
  class ReturnShipmentReceivedEvent
    # Shopify's return order id.
    attr_accessor :id

    attr_accessor :status

    # Return shipment origin address could be customer's or aggregator facility's address.
    attr_accessor :source_address

    # Shopify's return processing facility address.
    ...
    # Buyer shipped at date
    attr_accessor :shipped_at

    # Received for inspection date
    attr_accessor :received_at

    # Inspection performed at date
    attr_accessor :inspected_at

    # Notes captured by operations to pass any unexpected/unusual item or package details.
    attr_accessor :inspection_notes
    ...
    def self.openapi_types
      {
        :'id' => :'Object',
        :'status' => :'ReturnStatus',
        :'source_address' => :'LegacyReturnsSourceAddress',
        :'destination_address' => :'LegacyReturnsDestinationAddress',
        :'shipping_labels' => :'Object',
        :'marketplace_order' => :'ReturnsApiMarketplaceOrder',
        :'rma' => :'Object',
        :'external_return_id' => :'Object',
        :'return_items' => :'Object',
        :'shipped_at' => :'Object',
        :'received_at' => :'Object',
        :'inspected_at' => :'Object',
        :'inspection_notes' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ReturnShipmentReceivedEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ReturnShipmentReceivedEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipping_labels')
        self.shipping_labels = attributes[:'shipping_labels']
      else
        self.shipping_labels = nil
      end

      if attributes.key?(:'marketplace_order')
        self.marketplace_order = attributes[:'marketplace_order']
      else
        self.marketplace_order = nil
      end
      ...
      if attributes.key?(:'inspection_notes')
        self.inspection_notes = attributes[:'inspection_notes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inspection_notes == o.inspection_notes &&
    ...
    def hash
      [id, status, source_address, destination_address, shipping_labels, marketplace_order, rma, external_return_id, return_items, shipped_at, received_at, inspected_at, inspection_notes, logistics_account_id, logistics_event_id, logistics_event_type, logistics_event_time].hash
    end
