  ...
  class ReturnUpdatedEvent
    ...
    def self.openapi_types
      {
        ...
        :'source_address' => :'DeliverrAddress',
        :'shipping_label' => :'ShippingLabel',
        :'rma' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ReturnUpdatedEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ReturnUpdatedEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @shipping_label.nil?
        invalid_properties.push('invalid value for "shipping_label", shipping_label cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @shipping_label.nil?
    ...
    def hash
      [id, status, source_address, shipping_label, rma, external_return_id, return_items, shipped_at, received_at, inspected_at, logistics_account_id, logistics_event_id, logistics_event_type, logistics_event_time].hash
    end
