...
module Flexport
  class ShortShippedBoxIssue
    # The current status of the short ship
    attr_accessor :status

    # Who resolved the issue
    attr_accessor :resolved_by

    # How many boxes are affected by the issue
    attr_accessor :reported_boxes
    ...
    def self.openapi_types
      {
        :'status' => :'ShortShippedBoxStatus',
        :'resolved_by' => :'ShortShippedResolvedBy',
        :'reported_boxes' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::ShortShippedBoxIssue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::ShortShippedBoxIssue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reported_boxes')
        self.reported_boxes = attributes[:'reported_boxes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reported_boxes == o.reported_boxes
    end
    ...
    def hash
      [status, resolved_by, reported_boxes].hash
    end
