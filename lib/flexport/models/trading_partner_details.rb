...
module Flexport
  class TradingPartnerDetails
    attr_accessor :required_trading_partner_general_bol_fields

    attr_accessor :required_general_ltl_gs1_bol_fields

    attr_accessor :required_general_gs1_bol_fields
    ...
    def self.attribute_map
      {
        :'required_trading_partner_general_bol_fields' => :'requiredTradingPartnerGeneralBolFields',
        :'required_general_ltl_gs1_bol_fields' => :'requiredGeneralLtlGs1BolFields',
        :'required_general_gs1_bol_fields' => :'requiredGeneralGs1BolFields',
    ...
    def self.openapi_types
      {
        :'required_trading_partner_general_bol_fields' => :'Array<TradingPartnerGeneralBolFieldRequiredTradingPartnerGeneralBolInfo>',
        :'required_general_ltl_gs1_bol_fields' => :'Array<TradingPartnerGeneralBolFieldRequiredGeneralLtlGs1BolInfo>',
        :'required_general_gs1_bol_fields' => :'Array<TradingPartnerGeneralBolFieldRequiredGeneralGs1BolInfo>',
        :'trading_partner' => :'SupportedTradingPartner'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::TradingPartnerDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::TradingPartnerDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'required_trading_partner_general_bol_fields')
        if (value = attributes[:'required_trading_partner_general_bol_fields']).is_a?(Array)
          self.required_trading_partner_general_bol_fields = value
        end
      else
        self.required_trading_partner_general_bol_fields = nil
      end

      if attributes.key?(:'required_general_ltl_gs1_bol_fields')
        if (value = attributes[:'required_general_ltl_gs1_bol_fields']).is_a?(Array)
          self.required_general_ltl_gs1_bol_fields = value
        end
      else
        self.required_general_ltl_gs1_bol_fields = nil
      end

      if attributes.key?(:'required_general_gs1_bol_fields')
        if (value = attributes[:'required_general_gs1_bol_fields']).is_a?(Array)
          self.required_general_gs1_bol_fields = value
        end
      else
        self.required_general_gs1_bol_fields = nil
      end

      if attributes.key?(:'trading_partner')
        self.trading_partner = attributes[:'trading_partner']
      else
        self.trading_partner = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @required_trading_partner_general_bol_fields.nil?
        invalid_properties.push('invalid value for "required_trading_partner_general_bol_fields", required_trading_partner_general_bol_fields cannot be nil.')
      end

      if @required_general_ltl_gs1_bol_fields.nil?
        invalid_properties.push('invalid value for "required_general_ltl_gs1_bol_fields", required_general_ltl_gs1_bol_fields cannot be nil.')
      end

      if @required_general_gs1_bol_fields.nil?
        invalid_properties.push('invalid value for "required_general_gs1_bol_fields", required_general_gs1_bol_fields cannot be nil.')
      end

      if @trading_partner.nil?
        invalid_properties.push('invalid value for "trading_partner", trading_partner cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @required_trading_partner_general_bol_fields.nil?
      return false if @required_general_ltl_gs1_bol_fields.nil?
      return false if @required_general_gs1_bol_fields.nil?
      return false if @trading_partner.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          required_trading_partner_general_bol_fields == o.required_trading_partner_general_bol_fields &&
          required_general_ltl_gs1_bol_fields == o.required_general_ltl_gs1_bol_fields &&
          required_general_gs1_bol_fields == o.required_general_gs1_bol_fields &&
    ...
    def hash
      [required_trading_partner_general_bol_fields, required_general_ltl_gs1_bol_fields, required_general_gs1_bol_fields, trading_partner].hash
    end
