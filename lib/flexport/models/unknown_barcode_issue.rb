...
module Flexport
  class UnknownBarcodeIssue
    # URL for image
    attr_accessor :front_picture

    # URL for image
    attr_accessor :back_picture

    # URL for image
    attr_accessor :box_content_picture

    # URL for image
    attr_accessor :barcode_picture

    # When we received a resolution from the merchant
    attr_accessor :received_submission_at

    # When the issue was resolved after receiving a resolution
    ...
    def self.attribute_map
      {
        ...
        :'box_content_picture' => :'boxContentPicture',
        :'barcode_picture' => :'barcodePicture',
        :'received_submission_at' => :'receivedSubmissionAt',
    ...
    def self.openapi_types
      {
        :'front_picture' => :'Object',
        :'back_picture' => :'Object',
        :'box_content_picture' => :'Object',
        :'barcode_picture' => :'Object',
        :'received_submission_at' => :'Object',
        :'completed_at' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::UnknownBarcodeIssue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::UnknownBarcodeIssue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'front_picture')
        self.front_picture = attributes[:'front_picture']
      else
        self.front_picture = nil
      end

      if attributes.key?(:'back_picture')
        self.back_picture = attributes[:'back_picture']
      else
        self.back_picture = nil
      end

      if attributes.key?(:'box_content_picture')
        self.box_content_picture = attributes[:'box_content_picture']
      else
        self.box_content_picture = nil
      end

      if attributes.key?(:'barcode_picture')
        self.barcode_picture = attributes[:'barcode_picture']
      else
        self.barcode_picture = nil
      end

      if attributes.key?(:'received_submission_at')
        self.received_submission_at = attributes[:'received_submission_at']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          front_picture == o.front_picture &&
          back_picture == o.back_picture &&
          box_content_picture == o.box_content_picture &&
          barcode_picture == o.barcode_picture &&
          received_submission_at == o.received_submission_at &&
    ...
    def hash
      [front_picture, back_picture, box_content_picture, barcode_picture, received_submission_at, completed_at].hash
    end
