...
module Flexport
  class UpdateInboundShipmentRequestV3
    attr_accessor :from
    ...
    def self.openapi_types
      {
        ...
        :'packages' => :'Array<UpdatePackageInput>',
        :'freight_details' => :'UpdateFreightInputV3',
        :'package_tracking_number' => :'String',
        :'prep' => :'PrepRequestData',
        :'create_packages' => :'Array<PackageInputUnstable>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::UpdateInboundShipmentRequestV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::UpdateInboundShipmentRequestV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'freight_details')
        self.freight_details = attributes[:'freight_details']
      end
      ...
      if attributes.key?(:'create_packages')
        if (value = attributes[:'create_packages']).is_a?(Array)
          self.create_packages = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          packages == o.packages &&
          freight_details == o.freight_details &&
          package_tracking_number == o.package_tracking_number &&
          prep == o.prep &&
          create_packages == o.create_packages
    end
    ...
    def hash
      [from, shipping_option, packages, freight_details, package_tracking_number, prep, create_packages].hash
    end
