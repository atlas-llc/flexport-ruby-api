...
module Flexport
  class VariantIdDskuMapRequest
    attr_accessor :logistics_account_id

    attr_accessor :request_id

    attr_accessor :variant_id_dsku_map
    ...
    def self.attribute_map
      {
        ...
        :'variant_id_dsku_map' => :'variantIdDskuMap'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Flexport::VariantIdDskuMapRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Flexport::VariantIdDskuMapRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'variant_id_dsku_map')
        self.variant_id_dsku_map = attributes[:'variant_id_dsku_map']
      else
        self.variant_id_dsku_map = nil
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          variant_id_dsku_map == o.variant_id_dsku_map
    end
    ...
    def hash
      [logistics_account_id, request_id, variant_id_dsku_map].hash
    end
