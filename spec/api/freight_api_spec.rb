...
# Unit tests for Flexport::FreightApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FreightApi' do
  before do
  ...
  describe 'test an instance of FreightApi' do
    it 'should create an instance of FreightApi' do
      expect(@api_instance).to be_instance_of(Flexport::FreightApi)
    end
  end
  ...
  # unit tests for create_containers_order
  ...
  # @param drayage_order_request 
  # @param [Hash] opts the optional parameters
  # @return [DrayageOrderResponse]
  describe 'create_containers_order test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_containers_quote
  ...
  describe 'get_freight_orders test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_freight_ports
  # Get all ports
