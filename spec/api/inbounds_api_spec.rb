...
# Unit tests for Flexport::InboundsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InboundsApi' do
  before do
  ...
  describe 'test an instance of InboundsApi' do
    it 'should create an instance of InboundsApi' do
      expect(@api_instance).to be_instance_of(Flexport::InboundsApi)
    end
  end

  # unit tests for create_inbounding_shipment_v4
  # Create a shipment
  # Create an inbounding shipment.
  # @param create_inbound_shipment_request_v4 
  # @param [Hash] opts the optional parameters
  # @return [InboundShipmentResponseV4]
  describe 'create_inbounding_shipment_v4 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_inbounding_shipment_quote_purchase_result
  ...
  describe 'get_inbounding_shipment_quote_purchase_result test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_inbounding_shipment_quote_result
  ...
  # @option opts [InboundShippingOption] :shipping_option 
  # @return [QuoteResultResponse]
  describe 'get_inbounding_shipment_quote_result test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_inbounding_shipment_v4
  # Get a shipment
  # Get an inbounding shipment.
  # @param shipment_id 
  # @param [Hash] opts the optional parameters
  # @return [InboundShipmentResponseV4]
  describe 'get_inbounding_shipment_v4 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_inbounding_shipments_v4
  # Get a list of shipments
  # Get inbounding shipments based on the provided shipmentIds.
  # @param shipment_ids 
  # @param [Hash] opts the optional parameters
  # @return [Array<InboundShipmentResponseV4>]
  describe 'get_inbounding_shipments_v4 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_transfer_document_v2
  # Request document for a shipment
  # Request document for an inbounding shipment.
  # @param shipment_id 
  # @param document_option 
  # @param document_format 
  # @param [Hash] opts the optional parameters
  # @return [DocumentResponse]
  describe 'get_transfer_document_v2 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for init_quote_process_for_inbounding_shipment_v2
  ...
  describe 'init_quote_process_for_inbounding_shipment_v2 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for init_quote_purchase_process_for_inbounding_shipment_v2
  ...
  # @param shipment_id 
  # @param purchase_quotes_request 
  # @param [Hash] opts the optional parameters
  # @return [InboundRateBuyResultV2]
  describe 'init_quote_purchase_process_for_inbounding_shipment_v2 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_inbounding_shipment_v3
  # Update a shipment
  # Update an inbounding shipment.
  # @param shipment_id 
  # @param update_inbound_shipment_request_v3 
  # @param [Hash] opts the optional parameters
  # @return [InboundShipmentResponseV3]
  describe 'update_inbounding_shipment_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
