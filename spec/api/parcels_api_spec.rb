...
# Unit tests for Flexport::ParcelsApi
...
describe 'ParcelsApi' do
  ...
  describe 'test an instance of ParcelsApi' do
    it 'should create an instance of ParcelsApi' do
      expect(@api_instance).to be_instance_of(Flexport::ParcelsApi)
    end
  end

  # unit tests for cancel_parcel
  # Cancel a parcel
  # Cancels a parcel that was previously created.
  # @param cancel_parcel_request 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'cancel_parcel test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_bulk_parcel_job
  # Create a bulk parcel job
  # Create a Bulk Parcel Job.
  # @param body The bulk parcel job request
  # @param [Hash] opts the optional parameters
  # @return [BulkParcelJobResponse]
  describe 'create_bulk_parcel_job test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_parcel_v3
  # Create a parcel
  # Create a parcel and purchase a label for that parcel.
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [Parcel]
  describe 'create_parcel_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_bulk_parcel_job
  # Get a Bulk Parcel Job by ID
  # Fetch the Bulk Parcel Job for the specified ID.
  # @param id The Bulk Parcel Job ID
  # @param [Hash] opts the optional parameters
  # @return [BulkParcelJobResponse]
  describe 'get_bulk_parcel_job test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for get_parcel_tracking_by_tracking_code
  ...
  # @param tracking_code tracking code used to track the parcel
  # @param [Hash] opts the optional parameters
  # @return [ParcelTracking]
  describe 'get_parcel_tracking_by_tracking_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
