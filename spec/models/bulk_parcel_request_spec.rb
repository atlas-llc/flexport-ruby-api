...
# Unit tests for Flexport::BulkParcelRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::BulkParcelRequest do
  let(:instance) { Flexport::BulkParcelRequest.new }

  describe 'test an instance of BulkParcelRequest' do
    it 'should create an instance of BulkParcelRequest' do
      expect(instance).to be_instance_of(Flexport::BulkParcelRequest)
    end
  end
  ...
  describe 'test attribute "custom_label_footer_fields"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "customs_information"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "integration_channel"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "packslip_notes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
