...
# Unit tests for Flexport::CreateParcelRequestUnstable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::CreateParcelRequestUnstable do
  let(:instance) { Flexport::CreateParcelRequestUnstable.new }

  describe 'test an instance of CreateParcelRequestUnstable' do
    it 'should create an instance of CreateParcelRequestUnstable' do
      expect(instance).to be_instance_of(Flexport::CreateParcelRequestUnstable)
    end
  end
