...
# Unit tests for Flexport::OrderModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::OrderModel do
  let(:instance) { Flexport::OrderModel.new }

  describe 'test an instance of OrderModel' do
    it 'should create an instance of OrderModel' do
      expect(instance).to be_instance_of(Flexport::OrderModel)
    end
  end
  ...
  describe 'test attribute "promised_delivery_by_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "promised_ship_by_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
