...
# Unit tests for Flexport::PartnerApplication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::PartnerApplication do
  let(:instance) { Flexport::PartnerApplication.new }

  describe 'test an instance of PartnerApplication' do
    it 'should create an instance of PartnerApplication' do
      expect(instance).to be_instance_of(Flexport::PartnerApplication)
    end
  end
  ...
  describe 'test attribute "is_test_application"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "public_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SUBMITTED", "APPROVED", "REJECTED"])
      # validator.allowable_values.each do |value|
      #   expect { instance.public_status = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "install_uri"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
