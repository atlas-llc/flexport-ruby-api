...
# Unit tests for Flexport::ReturnInspectedEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::ReturnInspectedEvent do
  let(:instance) { Flexport::ReturnInspectedEvent.new }

  describe 'test an instance of ReturnInspectedEvent' do
    it 'should create an instance of ReturnInspectedEvent' do
      expect(instance).to be_instance_of(Flexport::ReturnInspectedEvent)
    end
  end
