...
# Unit tests for Flexport::ReturnShipmentReceivedEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::ReturnShipmentReceivedEvent do
  let(:instance) { Flexport::ReturnShipmentReceivedEvent.new }

  describe 'test an instance of ReturnShipmentReceivedEvent' do
    it 'should create an instance of ReturnShipmentReceivedEvent' do
      expect(instance).to be_instance_of(Flexport::ReturnShipmentReceivedEvent)
    end
  end
  ...
  describe 'test attribute "inspection_notes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "logistics_account_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "logistics_event_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "logistics_event_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "logistics_event_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
