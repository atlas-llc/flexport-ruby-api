...
# Unit tests for Flexport::ReturnShippedEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::ReturnShippedEvent do
  let(:instance) { Flexport::ReturnShippedEvent.new }

  describe 'test an instance of ReturnShippedEvent' do
    it 'should create an instance of ReturnShippedEvent' do
      expect(instance).to be_instance_of(Flexport::ReturnShippedEvent)
    end
  end
