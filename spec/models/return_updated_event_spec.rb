...
# Unit tests for Flexport::ReturnUpdatedEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Flexport::ReturnUpdatedEvent do
  let(:instance) { Flexport::ReturnUpdatedEvent.new }

  describe 'test an instance of ReturnUpdatedEvent' do
    it 'should create an instance of ReturnUpdatedEvent' do
      expect(instance).to be_instance_of(Flexport::ReturnUpdatedEvent)
    end
  end
  ...
  describe 'test attribute "shipping_label"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
